import{b as V,c as k,a as P,$ as t,g as ba,d as R,i as na,h as ra,q as la,w as ca,l as ya,o as $a,m as Sa,f as da}from"./init-D9JqHDy7.js";/* empty css              */import{f as wa}from"./foo-D1XQkuJl.js";import{g as C,s as x,d as ua,C as X,N as v,m as Ta,e as Pa,h as ea,M as pa,r as Q,i as oa}from"./widev-BIaVfPmz.js";function F(){const a=C(`empleadosPuntos_${g}`);if(a)return sa(a);if(!h.length)return t(".app").html('<div class="estado-vacio"><i class="fa-solid fa-spinner fa-spin"></i><p>Cargando empleados...</p></div>');x(`empleadosPuntos_${g}`,h,5),sa(h)}function sa(a){const e=a.map((o,s)=>{const c=s+1,l=c===1?"champion":c===2?"runner-up":"",r=c===1?"crown":c===2?"medal":"user";return`
