import{D as dt,t as I,F as q,a as m,b as F,q as L,c as P,e as E,l as D,h as K,$ as e,G as ut,N as i,H as Q,y as Z,C as B,x as ft,d as S,B as $,j as k,I as j,i as H,E as pt}from"./widev-DAl-lKpc.js";let f=null,w=new Date(new Date().toLocaleString("en-US",{timeZone:"America/Lima"})).toISOString().slice(0,7),b="todos",l=0,T=0,v=[],y=[],u=[],A=7,p=[],N=!1,R=null;dt(K,async t=>{if(!t)return window.location.href="/";R=t;try{const o=I("wiSmileTop");if(o)return W(o),q(m,R);const n=(await F(L(P(m,"smiles"),E("usuario","==",t.displayName)))).docs[0].data();D("wiSmile",n,450),W(n),q(m,R)}catch(o){console.error(o)}});async function W(t){f=t,console.log(`✅ Admin: ${t.nombre}`),e(".app").html(mt()),ut();try{await tt(),await z(),await at(),await _(),await nt(),vt(),C(),x(),i("Bienvenido "+t.nombre,"success")}catch(o){console.error("Error init:",o),i("Error al inicializar","error")}}function mt(){return`
