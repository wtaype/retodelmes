import{$ as a}from"./vendor-PbmUQHyn.js";import{e as t,z as c,r,g as n,q as l,l as f,w as d}from"./index-efS8M9Pg.js";const k=[{tit:"YouTube",ico:"fab fa-youtube",url:"https://www.youtube.com/@wiihope",bg:"#ff0000"},{tit:"Facebook",ico:"fab fa-facebook-f",url:"https://www.facebook.com/wiihopee",bg:"#1877F2"},{tit:"Instagram",ico:"fab fa-instagram",url:"https://www.instagram.com/WiiHopee",bg:"linear-gradient(45deg,#f58529,#dd2a7b,#515bd4)"},{tit:"TikTok",ico:"fab fa-tiktok",url:"https://www.tiktok.com/@wiihope",bg:"#000"}];function p(){const s=new Date;return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
          <span class="foo_app"><a href="/">${t}</a></span>
      ...
      <div class="foo_right">
        <span>Creado con <i class="fas fa-heart" style="color:var(--mco);"></i> by <a href="${r}" target="_blank"><strong>${n}</strong></a> ${l} - ${s.getFullYear()}</span>
      </div>
    </div>
  </footer>
  `}a(".foo").length||a("body").append(p());a("#wi_bg_style").length||a("head").append('<style id="wi_bg_style">:root{--bgim:url("/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');const e="cookies",i=s=>{d(e,s),a("#cookiess").removeClass("cookiess_show"),setTimeout(()=>a("#cookiess").remove(),400)};a(document).on("click","#ck_aceptar",()=>i(!0));a(document).on("click","#ck_rechazar",()=>i(!1));f(e)?a("#cookiess").remove():(a("#cookiess").length||a("body").append(`
      ...
      </div>`),setTimeout(()=>a("#cookiess").addClass("cookiess_show"),800));export{p as footer};
