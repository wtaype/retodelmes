import{r as e}from"./vendor-CZ6bxb2j.js";import{f as t,h as n,i as r,m as i,n as a,t as o}from"./widev-BkR2Na_W.js";import"./index-DKV-3SlD.js";import{A as s,N as c,O as l,_ as u,w as d}from"./firebase-BXqel3Di.js";import{n as f}from"./firebase-Cc-Gk9nK.js";import{iniciarModal as p}from"./trabajador_nuevo-8uF54m5p.js";var m=[],h=`todos`,g=``,_=null,v=!1,y=`rrhhUsuarios`,b=30,x=e=>((e.nombre||``)+` `+(e.apellidos||``)||e.usuario||`?`).trim().split(/\s+/).slice(0,2).map(e=>(e[0]||``).toUpperCase()).join(``),S=(e,t=40)=>{if(e.imagen)return`<div class="rrhh_avatar" style="width:${t}px;height:${t}px"><img src="${e.imagen}" alt="${o(e.nombre||e.usuario||`?`)}" loading="lazy"/></div>`;let n=x(e);return`<div class="rrhh_avatar rrhh_avatar_initials" data-rol="${e.rol||`smile`}" style="width:${t}px;height:${t}px;font-size:${Math.round(t*.36)}px">${n}</div>`},C=e=>{let t=(e||`smile`).toLowerCase();return`<span class="rrhh_rol_badge rrhh_rol_${t}">${o(t)}</span>`},w=(e,t)=>{let n=t===`activo`;return`
