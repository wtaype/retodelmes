/* empty css               *//* empty css                 */import{$ as i}from"./vendor-2D3jvCpt.js";import{x as l,d as r,K as t}from"./index-CGMM99MM.js";const c=[{ico:"fa-user-shield",color:"#0EBEFF",num:"01",tit:"Uso de la Plataforma",body:`<p>Este aplicativo es una herramienta digital de uso exclusivo para el personal de guías y agentes comerciales autorizados. Al acceder a la plataforma, te comprometes a:</p>
    <ul class="tm_list">
...
<div class="ac_wrap tm_wrap">
  ...
  <div class="tm_index_band">
    ${c.map((a,e)=>`
      <a href="#tm_sec_${e}" class="tm_index_item">
  ...
  <section class="ac_sec tm_secciones">
    ...
    <div class="tm_secs_grid">
      ${c.map((a,e)=>`
        <div class="tm_sec_card wi_fadeUp" id="tm_sec_${e}">
...
`;let o=null;const f=()=>{const a=new IntersectionObserver(e=>{e.forEach(s=>{s.isIntersecting&&i(s.target).addClass("visible")})},{threshold:.1});o=a,i(".wi_fadeUp").each(function(){a.observe(this)}),i(document).on("click.terminos",".tm_nav",function(e){e.preventDefault();const{rutas:s}=window._wiRutas??{};s?.navigate?.(i(this).attr("href"))}),i(document).on("click.terminos",".tm_index_item",function(e){e.preventDefault();const s=document.querySelector(i(this).attr("href"));s&&window.scrollTo({top:s.getBoundingClientRect().top+scrollY-90,behavior:"smooth"})}),window.wiInitTips&&window.wiInitTips(),console.log(`📜 ${r} Términos cargados`),window.__WIREADY__=!0},v=()=>{o?.disconnect?.(),o=null,i(document).off(".terminos")};export{v as cleanup,f as init,u as render};
