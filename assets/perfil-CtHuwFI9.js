import{r as e}from"./vendor-CZ6bxb2j.js";import{T as t,f as n,h as r,r as i,y as a}from"./widev-BkR2Na_W.js";import{n as o}from"./index-4xtKSgn6.js";import{k as s,u as c,w as l}from"./firebase-COMEVlQu.js";import{n as u,t as d}from"./firebase-srJqeJFD.js";var f=()=>n(`wiSmile`)||{},p=()=>{let e=f();if(!e.email)return location.replace(`/`),``;let t=e.nombre||``,n=e.apellidos||``,r=e.usuario||``,i=e.email||``,o=e.rol||`smile`,s=e.plan||`free`,c=e.estado||`activo`;(e.tema||`Por defecto`).split(`|`)[0],e.uid;let l=e.avatar||``,u=e.fechaNacimiento||``,d=e.pais||``,p=e.genero||``,m=e.gustos||``,h=e.bio||``,g=e.creacion||e.creado,_=g?a(null).get(g,`local`):`Desconocido`,v=`https://ui-avatars.com/api/?name=`+encodeURIComponent(t+` `+n)+`&background=random&color=fff`;return`
  <div class="prf_wrap">
