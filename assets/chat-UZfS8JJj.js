import{r as e}from"./vendor-CZ6bxb2j.js";import{C as t,f as n,h as r,i,n as a,v as o,w as s}from"./widev-BkR2Na_W.js";import{A as c,C as l,N as u,O as d,_ as f,b as p,m as ee,p as te,v as m,x as h}from"./firebase-BXqel3Di.js";import{n as g}from"./firebase-Cc-Gk9nK.js";import{cargarTodosEmpleados as _}from"./zsmile-DFnR68aQ.js";var v=`.chat`,y=`chatSmileMsgs`,b=.1,x=7,S=5,C=3e4,w=500,T=[],E=[],D=``,O=null,k=!1,A=``,j=``,M=!1,N=!0,P=null,F=()=>`
...
`;function I(){return[,,,,,].fill(0).map(()=>`
  ...
  `,U=e=>String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`),W=e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),G=()=>{let t=e(`#chatTextarea`).val()||``;e(`.chat_sidebar_item`).each(function(){let n=(e(this).attr(`data-nombre`)||``).trim();n&&(RegExp(`@`+W(n)+`(?![a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ])`,`i`).test(t)?e(this).addClass(`active`):e(this).removeClass(`active`))})},K=(t=!1)=>{let n=e(`#chatMessages`);if(!T.length){n.html(`
    ...
    `}).join(``);t.html(r),G()},J=(e=!1)=>{let t=document.getElementById(`chatMessages`);t&&t.scrollTo({top:t.scrollHeight,behavior:e?`smooth`:`auto`})},Y=t=>{e(`#chatOnlineCount`).text(t)},X=async(t=!1)=>{if(!M){if(M=!0,!t){let e=n(y);if(e&&Array.isArray(e)){T=e,N=!0,K(),M=!1;return}}t&&e(`#chatRefresh`).addClass(`chat_spinning`),e(`#chatHeader`).addClass(`smw_loading`);try{let e=await f(h(d(g,`chatSmiles`),p(`creado`,`desc`),m(x)));T=e.docs.reverse().map(e=>({id:e.id,...e.data()})),N=e.size>=x,r(y,T,b),K(),Y(new Set(T.map(e=>e.usuario||e.autor).filter(Boolean)).size)}catch(t){console.error(`[Chat] loadMensajes error:`,t),T.length||e(`#chatMessages`).html(`
