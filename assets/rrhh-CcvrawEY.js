import{$ as r}from"./vendor-2D3jvCpt.js";import{db as p}from"./firebase-lQbfGFXx.js";import{i as k,c as R,A as f,e as g,u as P}from"./firebase-BwR1K4LJ.js";import{b as n,j as $,u,a as E,C as m,r as y}from"./index-D2CM3kGN.js";let e=[],h="todos",b="",_=null,C=!1;const c="rrhhUsuarios",v=30,I=s=>((s.nombre||"")+" "+(s.apellidos||"")||s.usuario||"?").trim().split(/\s+/).slice(0,2).map(a=>(a[0]||"").toUpperCase()).join(""),A=(s,a=40)=>{if(s.imagen)return`<div class="rrhh_avatar" style="width:${a}px;height:${a}px"><img src="${s.imagen}" alt="${m(s.nombre||s.usuario||"?")}" loading="lazy"/></div>`;const t=I(s);return`<div class="rrhh_avatar rrhh_avatar_initials" data-rol="${s.rol||"smile"}" style="width:${a}px;height:${a}px;font-size:${Math.round(a*.36)}px">${t}</div>`},H=s=>{const a=(s||"smile").toLowerCase();return`<span class="rrhh_rol_badge rrhh_rol_${a}">${m(a)}</span>`},B=(s,a)=>{const t=a==="activo";return`
