import{r as e}from"./vendor-CZ6bxb2j.js";import{C as t,T as n,f as r,i}from"./widev-BkR2Na_W.js";import"./index-Bq5gtrcG.js";import{a,g as o,l as s,m as c,n as l,o as u,p as d,v as f,x as p}from"./firebase-D6VL4aaK.js";import{n as m}from"./firebase-BfEAzf30.js";var h=[],g=null,_=``,v=!0,y=!1,b=null,x=`wiWin`,S=`wi_win_cache`,C=()=>r(`wiSmile`)||{},w=e=>localStorage.setItem(S,JSON.stringify(e)),T=()=>JSON.parse(localStorage.getItem(S)||`[]`),E=()=>h.sort((e,t)=>!!t.pin-+!!e.pin||(t.fechaActualizado?.seconds||0)-(e.fechaActualizado?.seconds||0)),D=()=>({seconds:Math.floor(Date.now()/1e3)}),O=async(t,n=!1)=>{if(y=!t?.email,y){v=!1,k();return}n||e(`.es_btn_refresh`).addClass(`syncing`);try{h=(await a(s(o(m,x),d(`email`,`==`,t.email),u(100)))).docs.map(e=>({_fsId:e.id,...e.data()})),E(),w(h),v=!1,k()}catch{v=!1,n||L()}finally{e(`.es_btn_refresh`).removeClass(`syncing`)}},k=()=>{g||=h.find(e=>e.pin)||h[0]||null,L()},A=async(n=!1)=>{if(!g)return;let r=C(),a=e(`#btnS2`),o=e(`.es_in_title_h`).val().trim()||`Untitled`,s=e(`.es_editor`).html();g.titulo=o,g.contenido=s,g._dirty&&(g.fechaActualizado=D());let l=h.filter(e=>e._dirty);if(!l.length){n&&i(`Sin cambios por guardar`,`info`,800);return}if(w(h),n&&t(a,!0,`Guardando`),y){l.forEach(e=>e._dirty=!1),w(h),F(),n&&setTimeout(()=>{t(a,!1,`Guardado`),setTimeout(()=>a.html(`<i class="fas fa-save"></i> <span id="iconSync">Guardar</span>`),1500)},600);return}try{let e=c(m);for(let t of l){let n={id:t.id,titulo:t.titulo||`Untitled`,contenido:t.contenido||``,email:r.email,usuario:r.usuario||`Public`,fecha:t.fecha||p(),fechaActualizado:p(),pin:!!t.pin};e.set(f(m,x,t._fsId),n),t._dirty=!1}await e.commit(),w(h),F(),n&&(i(`Sincronización Exitosa ✨`,`success`,800),t(a,!1,`Guardado`))}catch(e){n&&(console.error(`Save Error:`,e),i(`Error al guardar`,`error`),t(a,!1,`Reintentar`))}finally{n&&setTimeout(()=>{e(`#btnS2`).length&&e(`#btnS2`).html(`<i class="fas fa-save"></i> <span>Guardar</span>`)},2e3)}},j=async()=>{let t=C(),n=`win${Date.now()}`,r=D(),i={_fsId:n,id:n,titulo:``,contenido:``,pin:!1,email:t.email||`guest`,usuario:t.usuario||`Public`,fecha:r,fechaActualizado:r,_dirty:!0};h.unshift(i),g=i,w(h),L(),e(`.es_in_title_h`).focus(),e(`.es_container`).removeClass(`menu-open`)},M=async(n,r=null)=>{if(confirm(`¿Eliminar?`)){r&&t(e(r),!0,`...`);try{h=h.filter(e=>e._fsId!==n),g?._fsId===n&&(g=h[0]||null),w(h),y||await l(f(m,x,n)),L()}catch{r&&t(e(r),!1,`<i class="fas fa-trash-alt"></i>`),i(`Error al eliminar`,`error`)}}},N=async e=>{let t=h.find(t=>t._fsId===e);t&&(t.pin=!t.pin,t._dirty=!0,t.fechaActualizado=D(),E(),w(h),L())},P=()=>{e(`.es_tool_btn[data-cmd]`).each(function(){let t=e(this).data(`cmd`);try{document.queryCommandState(t)?e(this).addClass(`active`):e(this).removeClass(`active`)}catch{}});try{let t=window.getSelection().anchorNode;if(t){let n=t.nodeType===3?t.parentNode:t;if(e(n).closest(`.es_editor`).length){let t=window.getComputedStyle(n);if(t.fontSize&&e(`#winFontSize`).val(parseInt(t.fontSize)),t.fontFamily){let n=t.fontFamily.split(`,`)[0].replace(/['"]/g,``);e(`#winFontFamily option`).each(function(){(e(this).text()===n||e(this).val().includes(n))&&e(`#winFontFamily`).val(e(this).val())})}let r=e(n).closest(`p, div, h1, h2, h3, h4, h5, h6, li`);if(r.length){let n=r[0].style.lineHeight;n&&e(`#winLineHeight`).val(n),r[0].style.marginBottom===`0px`||t.marginBottom===`0px`?e(`#btnNoMargin`).addClass(`active`):e(`#btnNoMargin`).removeClass(`active`)}}}}catch{}},F=()=>{let t=h.filter(e=>(e.titulo||``).toLowerCase().includes(_.toLowerCase()));e(`.es_list_items_final`).html(t.map(t=>{let r=t.titulo||`Untitled`,i=e(`<div>`).html(t.contenido||``).text().trim()||`Sin contenido...`,a=i.length>30?i.substring(0,30)+`...`:i,o=!t._dirty,s=new Date((t.fechaActualizado?.seconds||Date.now()/1e3)*1e3).toLocaleDateString(`es-ES`,{day:`2-digit`,month:`short`});return`
