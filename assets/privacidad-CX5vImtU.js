...
import{z as c,_ as t,e as l,O as r}from"./index-efS8M9Pg.js";/* empty css               *//* empty css                 */import{$ as i}from"./vendor-PbmUQHyn.js";const o=[{ico:"fa-database",color:"#0EBEFF",num:"01",tit:"Información que Recopilamos",body:`<p>Para el correcto funcionamiento de la plataforma interna de ventas y comisiones, recopilamos únicamente los datos necesarios:</p>
    <ul class="tm_list">
...
`;let e=null;const _=()=>{e=new IntersectionObserver(a=>a.forEach(s=>{s.isIntersecting&&i(s.target).addClass("visible")}),{threshold:.1}),i(".wi_fadeUp").each(function(){e.observe(this)}),i(document).on("click.privacidad",".tm_nav",function(a){a.preventDefault(),t(()=>import("./index-efS8M9Pg.js").then(s=>s.v),__vite__mapDeps([0])).then(s=>s.rutas.navigate(i(this).attr("href")))}),i(document).on("click.privacidad",".tm_index_item",function(a){a.preventDefault();const s=document.querySelector(i(this).attr("href"));s&&window.scrollTo({top:s.getBoundingClientRect().top+scrollY-90,behavior:"smooth"})}),console.log(`🔒 ${l} Privacidad cargada`),window.__WIREADY__=!0},f=()=>{e?.disconnect?.(),e=null,i(document).off(".privacidad")};export{f as cleanup,_ as init,u as render};
