const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/admin-FWOua3Ty.css","assets/mifcm-DMGZebNt.css","assets/permisos-DocH6Ucx.css","assets/sistema-C3OQ-N0f.css","assets/usuarios-BMnNRUe5.css","assets/ganancias-Bgtvc0oR.css","assets/gestor-C2mWujYN.css","assets/precios-RaoK6dN1.css","assets/trabajador_nuevo-naRT-yo4.css","assets/rrhh-DT8y9L-t.css","assets/chat-DbUbhovl.css","assets/crear-DdIpSs_P.css","assets/historial-QQOoXvcn.css","assets/mensajes-MIv6zaMF.css","assets/metricas-C7zPbHpQ.css","assets/more-K5CU7iQA.css","assets/perfil-BZqPOASC.css","assets/ranking-DHQqZCjY.css","assets/registrar-100lNd6S.css","assets/smile-BWbZimzl.css","assets/tours-BXLv0e8Y.css","assets/win-CFprZW1q.css","assets/verificar-mialvYKy.css","assets/acerca-rEkuWwpI.css","assets/contacto-C-QNnnsD.css","assets/terminos-CEyXQAUt.css","assets/descubre-D_yf6JJ_.css","assets/blog-Pvtd5AbW.css","assets/nuevo-BJdQZpYp.css","assets/post-CaVCZ_Tu.css","assets/chatwil-R1-t4gNv.css","assets/emojis-GLPEIk5R.css","assets/login-CmMlLPC3.css","assets/precios-D9xczg9-.css","assets/registrado-DMFE_p3X.css"])))=>i.map(i=>d[i]);
...
<div class="ini_wrap">
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <p class="ini_cta_autor" style="margin-top:2vh;">Creado con ❤️ por <a href="${n}" target="_blank" rel="noopener">${r}</a> · v35 © ${f()}</p>
    </div>
  </section>

</div>`,C=()=>{let e=0,n=t(`.ini_role`);setInterval(()=>{n.removeClass(`active`),n.eq(e=(e+1)%n.length).addClass(`active`)},2800),a(`#in_stats`,()=>{t(`.ini_stat_n`).each(function(){let e=t(this),n=+e.data(`target`),r=e.data(`sufijo`)||``,i=0,a=setInterval(()=>{i+=n/50,i>=n?(e.text(n+r),clearInterval(a)):e.text(Math.floor(i))},28)})}),a(`.ini_cat_card`,null,{anim:`wi_fadeUp`,stagger:80}),a(`.ini_about_card`,null,{anim:`wi_fadeUp`,stagger:140}),console.log(`🚀 ${i} v35 · Inicio OK`)},w=()=>{},T=(function(){let e=typeof document<`u`&&document.createElement(`link`).relList;return e&&e.supports&&e.supports(`modulepreload`)?`modulepreload`:`preload`})(),E=function(e){return`/`+e},D={},O=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=E(t,n),t in D)return;D[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:T,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},k=e({NAV:()=>M,ROL_PATH:()=>A,RUTAS:()=>N,rutas:()=>I}),A={smile:`/registrar`,gestor:`/gestor`,admin:`/admin`},j=[],M={todos:{nvleft:[{href:`/`,page:`inicio`,ico:`fa-house`,txt:`Bienvenido`},...j],nvright:[{isBtn:!0,cls:`bt_auth login`,ico:`fa-sign-in-alt`,txt:`Iniciar sessión`}]},smile:{nvleft:[{href:`/registrar`,page:`registrar`,ico:`fa-plus-circle`,txt:`Registrar Ventas`},{href:`/historial`,page:`historial`,ico:`fa-clipboard-list`,txt:`Historial Ventas`},{href:`/ranking`,page:`ranking`,ico:`fa-trophy`,txt:`Ranking`},{href:`/tours`,page:`tours`,ico:`fa-route`,txt:`Tours `},{href:`/more`,page:`more`,ico:`fa-ellipsis`,txt:`Más`},...j],nvright:[{href:`/chat`,page:`chat`,ico:`fa-comments`,txt:`Chat Grupal`},{isPerfil:!0},{isSalir:!0}]},gestor:{nvleft:[{href:`/gestor`,page:`gestor`,ico:`fa-house`,txt:`Dashboard`},{href:`/registrar`,page:`registrar`,ico:`fa-plus-circle`,txt:`Registrar Ventas`},{href:`/ranking`,page:`ranking`,ico:`fa-trophy`,txt:`Ranking`},{href:`/historial`,page:`historial`,ico:`fa-clipboard-list`,txt:`Historial Ventas`},{href:`/tours`,page:`tours`,ico:`fa-route`,txt:`Tours`},{href:`/precios`,page:`precios`,ico:`fa-tags`,txt:`Gestionar Trours`},{href:`/more`,page:`more`,ico:`fa-ellipsis`,txt:`Más`},...j],nvright:[{href:`/chat`,page:`chat`,ico:`fa-comments`,txt:`Chat Grupal`},{href:`/ganancias`,page:`ganancias`,ico:`fa-wallet`,txt:`Ganancias`},{href:`/rrhh`,page:`rrhh`,ico:`fa-users-gear`,txt:`Trabajadores`},{isPerfil:!0},{isSalir:!0}]},admin:{nvleft:[{href:`/admin`,page:`admin`,ico:`fa-globe`,txt:`Plataforma`},{href:`/usuarios`,page:`usuarios`,ico:`fa-users`,txt:`Usuarios`},{href:`/permisos`,page:`permisos`,ico:`fa-lock`,txt:`Permisos`},{href:`/sistema`,page:`sistema`,ico:`fa-cogs`,txt:`Sistema`},{href:`/chat`,page:`chat`,ico:`fa-comments`,txt:`Chat Grupal`},{href:`/more`,page:`more`,ico:`fa-ellipsis`,txt:`Más`}],nvright:[{href:`/mifcm`,page:`mifcm`,ico:`fa-bell`,txt:`Mi FCM`},{href:`/nuevo`,page:`nuevo`,ico:`fa-plus`,txt:`Post`},{isPerfil:!0},{isSalir:!0}]},verificar:{nvleft:[],nvright:[]}},N=[{path:`/inicio`,area:`web/`},{path:`/login`,area:`web/`},{path:`/emojis`,area:`web/`},{path:`/registrado`,area:`web/`},{path:`/blog`,area:`web/blog/`},{path:`/post`,area:`web/blog/`},{path:`/chatwil`,area:`web/chatwil/`},{path:`/acerca`,area:`web/acerca/`},{path:`/descubre`,area:`web/acerca/`},{path:`/terminos`,area:`web/acerca/`},{path:`/cookies`,area:`web/acerca/`},{path:`/privacidad`,area:`web/acerca/`},{path:`/feedback`,area:`web/acerca/`},{path:`/contacto`,area:`web/acerca/`},{path:`/smile`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/perfil`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/mensajes`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/nuevo`,area:`web/blog/`,roles:[`smile`,`gestor`,`admin`]},{path:`/registrar`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/ranking`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/historial`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/tours`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/chat`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/more`,area:`smile/`,roles:[`smile`,`gestor`,`admin`]},{path:`/rrhh`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/precios`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/ganancias`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/trabajador_nuevo`,area:`gestor/`,roles:null},{path:`/gestor`,area:`gestor/`,roles:[`gestor`,`admin`]},{path:`/admin`,area:`admin/`,roles:[`admin`]},{path:`/usuarios`,area:`admin/`,roles:[`admin`]},{path:`/permisos`,area:`admin/`,roles:[`admin`]},{path:`/sistema`,area:`admin/`,roles:[`admin`]},{path:`/mifcm`,area:`admin/`,roles:[`admin`]},{path:`/verificar`,area:`verificar/`,roles:[`admin`]}],P=Object.assign({"./admin/admin.js":()=>O(()=>import(`./admin-BcMCcIzw.js`),__vite__mapDeps([0])),"./admin/fcm.js":()=>O(()=>import(`./fcm-BvRk9kiK.js`),[]),"./admin/mifcm.js":()=>O(()=>import(`./mifcm-BIe5MWgF.js`),__vite__mapDeps([1])),"./admin/permisos.js":()=>O(()=>import(`./permisos-B8mwI3Fe.js`),__vite__mapDeps([2])),"./admin/sistema.js":()=>O(()=>import(`./sistema-CcHFtWSm.js`),__vite__mapDeps([3])),"./admin/usuarios.js":()=>O(()=>import(`./usuarios-DRzm7_Nm.js`),__vite__mapDeps([4])),"./gestor/ganancias.js":()=>O(()=>import(`./ganancias-CqWbuLj7.js`),__vite__mapDeps([5])),"./gestor/gestor.js":()=>O(()=>import(`./gestor-N_st4Xom.js`),__vite__mapDeps([6])),"./gestor/precios.js":()=>O(()=>import(`./precios-UiNj5yhf.js`),__vite__mapDeps([7])),"./gestor/rrhh.js":()=>O(()=>import(`./rrhh-6aBIqgWP.js`),__vite__mapDeps([8,9])),"./gestor/trabajador_nuevo.js":()=>O(()=>import(`./trabajador_nuevo-Gueehciu.js`),__vite__mapDeps([8])),"./gestor/trabajadores.js":()=>O(()=>import(`./trabajadores-BvRk9kiK.js`),[]),"./smile/chat.js":()=>O(()=>import(`./chat-CnuAo874.js`),__vite__mapDeps([10])),"./smile/crear.js":()=>O(()=>import(`./crear-CoCt5pFP.js`),__vite__mapDeps([11])),"./smile/historial.js":()=>O(()=>import(`./historial-CDQguYWQ.js`),__vite__mapDeps([12])),"./smile/mensajes.js":()=>O(()=>import(`./mensajes-Dlx3UAmW.js`),__vite__mapDeps([13])),"./smile/metricas.js":()=>O(()=>import(`./metricas-Bs-3QgGD.js`),__vite__mapDeps([14])),"./smile/more.js":()=>O(()=>import(`./more-BE9BLcAC.js`),__vite__mapDeps([15])),"./smile/perfil.js":()=>O(()=>import(`./perfil-4ZB5BnZv.js`),__vite__mapDeps([16])),"./smile/ranking.js":()=>O(()=>import(`./ranking-CnyaVBgw.js`),__vite__mapDeps([17])),"./smile/registrar.js":()=>O(()=>import(`./registrar-BdqgZkqx.js`),__vite__mapDeps([18])),"./smile/smile.js":()=>O(()=>import(`./smile-2ZkZ5psI.js`),__vite__mapDeps([19])),"./smile/tours.js":()=>O(()=>import(`./tours-B3KktyHO.js`),__vite__mapDeps([20])),"./smile/win.js":()=>O(()=>import(`./win-krHbir4E.js`),__vite__mapDeps([21])),"./smile/zsmile.js":()=>O(()=>import(`./zsmile-9OBMck8o.js`),[]),"./verificar/verificar.js":()=>O(()=>import(`./verificar-M9QdSRc5.js`),__vite__mapDeps([22])),"./web/404.js":()=>O(()=>import(`./404-DVIDtGB8.js`),[]),"./web/acerca/acerca.js":()=>O(()=>import(`./acerca-DgDYPFTx.js`),__vite__mapDeps([23])),"./web/acerca/contacto.js":()=>O(()=>import(`./contacto-Ri69eH1h.js`),__vite__mapDeps([24,23])),"./web/acerca/cookies.js":()=>O(()=>import(`./cookies-BHMekLCp.js`),__vite__mapDeps([23,25])),"./web/acerca/descubre.js":()=>O(()=>import(`./descubre-ef1YjOHt.js`),__vite__mapDeps([26])),"./web/acerca/feedback.js":()=>O(()=>import(`./feedback-pdRMImQK.js`),__vite__mapDeps([23,25])),"./web/acerca/privacidad.js":()=>O(()=>import(`./privacidad-CcQqOyTp.js`),__vite__mapDeps([23,25])),"./web/acerca/terminos.js":()=>O(()=>import(`./terminos-CV4S7Se4.js`),__vite__mapDeps([23,25])),"./web/blog/blog.js":()=>O(()=>import(`./blog-C4lQ345u.js`),__vite__mapDeps([27])),"./web/blog/nuevo.js":()=>O(()=>import(`./nuevo-CoZx2lOp.js`),__vite__mapDeps([28])),"./web/blog/post.js":()=>O(()=>import(`./post-DLuvRbJc.js`),__vite__mapDeps([29])),"./web/blog/woo.js":()=>O(()=>import(`./woo-DNkc3KUT.js`),[]),"./web/chatwil/chatwil.js":()=>O(()=>import(`./chatwil-BYN2vTHY.js`),__vite__mapDeps([30])),"./web/chatwil/config.js":()=>O(()=>import(`./config-CpJRQ2zz.js`),[]),"./web/chatwil/contexto.js":()=>O(()=>import(`./contexto-DBuxlkBG.js`),[]),"./web/chatwil/datawii.js":()=>O(()=>import(`./datawii-BvRk9kiK.js`),[]),"./web/chatwil/waa.js":()=>O(()=>import(`./waa-ClgJHSI_.js`),[]),"./web/emojis.js":()=>O(()=>import(`./emojis-DfMOW7Fy.js`),__vite__mapDeps([31])),"./web/login.js":()=>O(()=>import(`./login-CvwLM1HR.js`),__vite__mapDeps([32])),"./web/precios.js":()=>O(()=>import(`./precios-BFDN1K0O.js`),__vite__mapDeps([33])),"./web/registrado.js":()=>O(()=>import(`./registrado-C4YNB_Wv.js`),__vite__mapDeps([34]))}),F=(e,t)=>P[`./${e}${t}.js`],I=new class{constructor(){this.rutas={},this.cache={"/inicio":m},this.modActual=null,this.cargand=!1,this.HOME=`inicio`,this.main=`#wimain`,this.pathActual=null,this.isFirstLoad=!0}register(e,t){this.rutas[e]=t}inicio(){return Promise.resolve(m)}registerAll(e){let t={},n={};N.forEach(({path:e,area:r,roles:i=null,mod:a})=>{if(e===`/inicio`){t[e]=()=>this.inicio();return}let o=a??e.split(`/`).pop(),s=F(r,o);if(!s){console.warn(`[ruta] no encontrado: ${r}${o}.js`);return}i===null?t[e]=s:(n[e]??=[]).push({roles:i,imp:s})});let r=()=>Promise.resolve({render:()=>``,init:()=>setTimeout(()=>this.navigate(`/login`),0)});new Set([...Object.keys(t),...Object.keys(n)]).forEach(i=>{let a=t[i],o=n[i]||[],s=()=>{let t=e?.()||null;return o.find(e=>e.roles.includes(t))};if(!o.length)return this.register(i,a);if(!a)return this.register(i,()=>{let e=s();return e?e.imp():r()});this.register(i,()=>{let e=s();return e?e.imp():a()})})}async prefetch(e){let t=p.limpiar(e)===`/`?`/${this.HOME}`:p.limpiar(e);if(!(this.cache[t]||!this.rutas[t]))try{this.cache[t]=await this.rutas[t](),console.log(`⚡ Listo ${t.replace(`/`,``)}`)}catch{console.warn(`[ruta] prefetch falló:`,t)}}async navigate(e,n=!0){if(this.cargand)return;this.cargand=!0;let r=p.limpiar(e)===`/`?`/${this.HOME}`:p.limpiar(e),{getls:i}=await O(async()=>{let{getls:e}=await import(`./widev-BkR2Na_W.js`).then(e=>e.O);return{getls:e}},[]),a=i(`wiSmile`),o=N.find(e=>e.path===r),s=e=>(this.cargand=!1,this.navigate(e,!0));if(a){if([`/login`,`/`,`/inicio`].includes(r)||o&&o.roles&&!o.roles.includes(a.rol))return s(A[a.rol]||`/smile`);if([`/admin`,`/usuarios`,`/permisos`,`/sistema`,`/mifcm`].includes(r)){let e=a.rol===`admin`?a.estado===`activo`?sessionStorage.getItem(`vault_unlocked`)?null:`/verificar`:`/registrado`:`/`;if(e)return s(e)}}else if(o&&o.roles)return s(`/login`);try{this.modActual?.cleanup?.();let e=this.rutas[r]?null:r.slice(1),i=e?F(`web/blog/`,`post`):this.rutas[r]??F(`web/`,`404`),a=this.cache[r]??await i();e||(this.cache[r]=a);let[o]=await Promise.all([a.render(e)]);document.body.classList.remove(`is-public-profile`),this.marcarNav(r),window.dispatchEvent(new CustomEvent(`winavigate`,{detail:{norm:r}})),this.isFirstLoad&&t(this.main).children().length>0&&!window.__WIREADY__&&r===`/${this.HOME}`?this.isFirstLoad=!1:await l(this.main,o),this.isFirstLoad=!1,window.scrollTo(0,0),a.init?.(e),n&&p.poner(r===`/${this.HOME}`?`/`:r,document.title),this.pathActual=r,this.modActual=a}catch(e){if(e instanceof TypeError&&e.message.includes(`Failed to fetch`))return location.reload();d(`Error en la ruta`),console.error(`[ruta] navigate:`,e)}finally{this.cargand=!1}}marcarNav(e){let n=e.slice(1)||this.HOME;t(`.nv_item`).removeClass(`active`),t(`.nv_item[data-page="${n}"]`).addClass(`active`)}init(){this.marcarNav(p.actual===`/`?`/${this.HOME}`:p.limpiar(p.actual)),t(document).on(`click`,`.nv_item:not(.bt_salir)`,e=>{e.preventDefault();let n=t(e.currentTarget).data(`page`);this.navigate(n===this.HOME?`/`:`/${n}`)}).on(`mouseenter touchstart`,`.nv_item[data-page]`,e=>{let n=t(e.currentTarget).data(`page`);this.prefetch(n===this.HOME?`/`:`/${n}`)}),window.addEventListener(`popstate`,e=>{let t=e.state?.ruta||p.actual;(p.limpiar(t)===`/`?`/${this.HOME}`:p.limpiar(t))!==this.pathActual&&this.navigate(t,!1)}),this.navigate(p.actual,!1)}};I.registerAll(()=>u(`wiSmile`)?.rol),I.register(`/`,()=>I.inicio()),I.register(`/inicio`,()=>I.inicio()),I.init(),O(()=>import(`./header-BbWlXhMK.js`),[]),O(()=>import(`./footer-D-cnD9it.js`),[]),o({css:[`https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&display=swap`,`https://fonts.googleapis.com/css2?family=Outfit:wght@100..900&display=swap`,`https://fonts.googleapis.com/css2?family=Rubik:wght@300..900&display=swap`]});export{k as a,I as i,A as n,O as o,N as r,M as t};