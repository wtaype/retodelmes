import{r as e}from"./vendor-CZ6bxb2j.js";import{l as t}from"./wii-BvK6d7hI.js";import{T as n,c as r,i,n as a,o,t as s,v as c}from"./widev-BkR2Na_W.js";import{r as l}from"./index-CA-XJpFF.js";import{C as u,M as d,_ as f,a as p,f as m,g as h,i as g,l as _,p as v,u as y,v as b,x}from"./firebase-D6VL4aaK.js";import{n as S,t as C}from"./firebase-BfEAzf30.js";var w=`modalNuevoTrabajador`,T=`smiles`,E=!1,D=null,O=(e=8)=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(e=>e.toString(36)).join(``).slice(0,e),k=(e=``,t=``)=>{let n=e.trim().split(/\s+/)[0]||``,r=t.trim().split(/\s+/)[0]||``;return((n[0]||``)+r).toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9_]/g,``)},A=e=>e.toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9_]/g,``).trim(),j=(e,n)=>`${t}/trabajador_nuevo?activar=${encodeURIComponent(e)}&k=${encodeURIComponent(n)}`,M=()=>`
