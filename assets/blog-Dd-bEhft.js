...
import{c as $,m as y,I as o,l as x,_ as C}from"./index-B3suI07f.js";import{$ as s}from"./vendor-PbmUQHyn.js";import{s as w,d as P,p as T,j as D,n as I,h as N,c as u}from"./devblog-kZbdJebJ.js";import"./firebase-DDX1bF82.js";import"./firebase-BM1KOhEp.js";const k=16,j=8,B=[{id:"nuevo",icon:"fa-clock",label:"Recientes"},{id:"vistas",icon:"fa-fire",label:"Populares"}],O=l=>{const c=u(l.categoria);return`
  ...
  <div class="bl_wrap">
    ...
    <div class="bl_bar">
      ...
      <div class="bl_bar_right">
        <div class="bl_orden">${B.map(l=>`<button class="bl_ord_btn ${l.id==="nuevo"?"active":""}" data-ord="${l.id}"><i class="fas ${l.icon}"></i><span>${l.label}</span></button>`).join("")}</div>
