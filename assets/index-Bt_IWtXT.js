...
<div class="ini_wrap">
  ...
  <section class="ini_hero">
    ...
    <div class="ini_hero_visual">
      ...
      <div class="ini_ftech ini_ft1" style="--d:.5s"  ${d(`Buggies`)}><i class="fas fa-car-side"></i></div>
      <div class="ini_ftech ini_ft2" style="--d:.65s" ${d(`Sandboard`)}><i class="fas fa-person-snowboarding"></i></div>
      <div class="ini_ftech ini_ft3" style="--d:.8s"  ${d(`Bodegas`)}><i class="fas fa-wine-glass-alt"></i></div>
      <div class="ini_ftech ini_ft4" style="--d:.95s" ${d(`Parapente`)}><i class="fas fa-parachute-box"></i></div>
    </div>
  </section>
