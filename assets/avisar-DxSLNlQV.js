import{$ as s}from"./vendor-PbmUQHyn.js";import{auth as T,db as _}from"./firebase-BoXYLQFr.js";import{v as b,e as p,u as C,d as j,r as P,c as L,D as A,n as M,i as z}from"./firebase-BM1KOhEp.js";import{u as B,e as U,S as q,I as f,l as H,c as u}from"./index-_8gLK-S4.js";let o=[],w=null,g=null,h=null;const $="wi_notas_cache",E="wi_notas_cache_time",V=100,J=1200,K=300*1e3,S=()=>H("wiSmile")||{},l=a=>{try{localStorage.setItem($,JSON.stringify(a)),localStorage.setItem(E,Date.now().toString())}catch{}},x=()=>{try{return JSON.parse(localStorage.getItem($)||"[]")}catch{return[]}},G=()=>{const a=parseInt(localStorage.getItem(E)||"0");return Date.now()-a<K},R=()=>{localStorage.removeItem($),localStorage.removeItem(E)},y=[{id:"Cielo",hex:"#0EBEFF",bg:"rgba(14,190,255,.12)",tx:"var(--tx)",rgb:"14,190,255"},{id:"Dulce",hex:"#FF5C93",bg:"rgba(255,92,147,.12)",tx:"var(--tx)",rgb:"255,92,147"},{id:"Paz",hex:"#10B981",bg:"rgba(16,185,129,.12)",tx:"var(--tx)",rgb:"16,185,129"},{id:"Mora",hex:"#8B5CF6",bg:"rgba(139,92,246,.12)",tx:"var(--tx)",rgb:"139,92,246"},{id:"Sol",hex:"#F59E0B",bg:"rgba(245,158,11,.12)",tx:"var(--tx)",rgb:"245,158,11"}],O=()=>{const a=S();if(!a.email)return location.replace("/"),"";const t=a.nombre||a.usuario||a.email||T.currentUser?.email||"";return`
