import{$ as a}from"./vendor-PbmUQHyn.js";import{c as r,l as v,f as u}from"./index-q-muxlkU.js";import{db as p}from"./firebase-oqHtqqC9.js";import{h as g,e as _,A as y,r as $,c as w,D as E,i as P}from"./firebase-BM1KOhEp.js";const h=()=>v("wiSmile");let l=[];const x=()=>{const i=h();return!i||i.rol!=="admin"?'<div class="adp_page"><div class="adp_empty"><i class="fas fa-ban"></i><p>Acceso denegado.</p></div></div>':`
  <div class="adp_page">
