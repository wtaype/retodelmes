import{r as e}from"./vendor-CZ6bxb2j.js";import{t}from"./wii-BvK6d7hI.js";import{f as n,h as r,i}from"./widev-BkR2Na_W.js";import{g as a,l as o,p as s,r as c}from"./firebase-D6VL4aaK.js";import{n as l}from"./firebase-BfEAzf30.js";var u=()=>n(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
  ...
  </div>`},g=async()=>{let t=u();!t||t.rol!==`admin`||(e(document).off(`.am`),v(),y(),e(document).on(`click.am`,`#am_btn_refresh`,function(){let t=e(this).find(`i`).addClass(`fa-spin`);y(!0).then(()=>{setTimeout(()=>t.removeClass(`fa-spin`),500)})}))},_=()=>{e(document).off(`.am`)};function v(){e(`#am_n_total`).text(n(d)||`—`),e(`#am_n_pro`).text(n(f)||`—`),e(`#am_n_org`).text(n(p)||`—`),e(`#am_n_les`).text(n(m)||`45`)}async function y(t=!1){try{let u=a(l,`smiles`);if(t||!n(d)){let t=(await c(u)).data().count;r(d,t),e(`#am_n_total`).text(t)}if(t||!n(f)){let t=(await c(o(u,s(`rol`,`in`,[`gestor`,`empresa`,`admin`])))).data().count;r(f,t),e(`#am_n_pro`).text(t)}if(t||!n(p)){let t=(await c(o(u,s(`rol`,`==`,`empresa`)))).data().count;r(p,t),e(`#am_n_org`).text(t)}t&&i(`Estadísticas sincronizadas`,`success`)}catch(e){console.error(`[Admin] Error cargando stats:`,e),t&&i(`Error sincronizando`,`error`)}}export{_ as cleanup,g as init,h as render};