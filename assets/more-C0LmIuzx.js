import{r as e}from"./vendor-CZ6bxb2j.js";import{v as t}from"./widev-BkR2Na_W.js";import{n}from"./index-DKV-3SlD.js";var r=[{href:`/ranking`,ico:`fa-trophy`,txt:`Ranking`,desc:`Salón de campeones y posiciones de venta del mes.`},{href:`/tours`,ico:`fa-route`,txt:`Catálogo de Tours`,desc:`Tours oficiales, precios vigentes y puntos asignados.`},{href:`/chat`,ico:`fa-comments`,txt:`Chat Grupal`,desc:`Canal de comunicación en vivo con el equipo.`},{href:`/notas`,ico:`fa-book`,txt:`Notas Book`,desc:`Tu libreta de apuntes y recordatorios personales.`},{href:`/word`,ico:`fa-rocket`,txt:`Planificar`,desc:`Editor de documentos y planificación.`},{href:`/agregar`,ico:`fa-folder-plus`,txt:`Mis Recursos`,desc:`Almacena y organiza tus archivos de trabajo.`},{href:`/avisar`,ico:`fa-bullhorn`,txt:`Anuncios`,desc:`Mensajes y notificaciones del equipo.`},{href:`/precios`,ico:`fa-tags`,txt:`Gestionar Tours`,desc:`Configura y modifica el catálogo y precios oficiales.`},{href:`/ganancias`,ico:`fa-wallet`,txt:`Ganancias`,desc:`Calcula, audita y liquida comisiones del mes.`},{href:`/rrhh`,ico:`fa-users-gear`,txt:`Trabajadores`,desc:`Administración de personal y activación de cuentas.`},{href:`/permisos`,ico:`fa-lock`,txt:`Permisos`,desc:`Gestión de roles y privilegios de acceso.`},{href:`/sistema`,ico:`fa-cogs`,txt:`Sistema`,desc:`Configuración global y bitácora del sistema.`},{href:`/mifcm`,ico:`fa-bell`,txt:`Mi FCM`,desc:`Envío de notificaciones push a la aplicación.`},{href:`/nuevo`,ico:`fa-plus`,txt:`Crear Post`,desc:`Escribe y publica artículos en el blog.`}],i=()=>{let e=t.user;if(!e)return`<div class="z_page"><div class="z_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`;let i=e.rol||`smile`;return`
    <div class="z_wrap">
