const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-0GcI1z-x.css"])))=>i.map(i=>d[i]);
import{x as I,y as f,F as M,e as y,c as D,l as h,I as e,A as E,n as R,K as C,_ as m}from"./index-B3suI07f.js";import{a as L}from"./wiad-DWbEudQX.js";import{$ as a}from"./vendor-PbmUQHyn.js";import{i as T,b as z,g,l as V,m as j,k as O,o as w,t as q,a as B,e as N,f as P}from"./devblog-kZbdJebJ.js";import"./firebase-DDX1bF82.js";import"./firebase-BM1KOhEp.js";const _=s=>`<a href="/${s.slug||s.id}" class="po_rel_card" ${e(s.resumen||s.titulo)}><div class="po_rel_img"><img src="${s.imagen}" alt="${s.imagenAlt||s.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${s.categoria}</span><strong>${s.titulo}</strong><span class="po_rel_meta"><i class="fas fa-calendar"></i> ${w(s.actualizado||s.creado)} · <i class="fas fa-eye"></i> ${s.vistas||0} · <i class="fas fa-heart" style="color:#fe0149"></i> ${s.likes||0}</span></div></a>`,b=(s,i,t="po_fade po_visible")=>s||i?`
    ...
    <aside class="po_sidebar">
      <div class="po_side_card ${l}" style="--d:.15s">
        ...
        <div class="po_autor_box"><div class="po_autor_av"><img src="/smile.avif" alt="${s.autor}"/></div><div class="po_autor_info"><strong>${s.autor}</strong><span>${y} <i class="fas ${R}"></i></span></div></div>
      ...
      <div class="po_ad_sticky ${l}" style="--d:.3s; position: sticky; top: 8vh; margin-top: 2vh; text-align:center; min-height:600px;">
         ...
         <div class="wi_ad_fallback">${L}</div>
      </div>
    </aside>
  </div></div>`};let p=!1;const Y=s=>{const i=s&&h(`wi_post_${s}`);if(i)return p=!0,k(i,h(`wi_mas_${i.categoria}`)||[],h("wi_sidebar_posts")||[],s,!0);p=!1;const t=s&&O(s);return t?`
    <div class="po_wrap"><div class="po_layout"><div class="po_col_main"><div class="po_content">
      ...
      <div class="po_contenido po_fade" style="--d:.1s; min-height:98vh;"><div class="po_sk_body">${'<div class="po_sk_p shimmer"></div>'.repeat(6)}</div></div>
        ...
        </div>`),a("#wi_yt_modal").on("click",function(t){t.target===this&&a(".wi_yt_close").trigger("click")})),a("#wi_yt_player").html(`<iframe width="100%" height="100%" src="https://www.youtube.com/embed/${s}?autoplay=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`);const{abrirModal:i}=await m(async()=>{const{abrirModal:t}=await import("./index-B3suI07f.js").then(o=>o.L);return{abrirModal:t}},__vite__mapDeps([0]));i("wi_yt_modal")}).on("click.post",".wi_yt_close",async function(){const{cerrarModal:s}=await m(async()=>{const{cerrarModal:i}=await import("./index-B3suI07f.js").then(t=>t.L);return{cerrarModal:i}},__vite__mapDeps([0]));s("wi_yt_modal"),setTimeout(()=>a("#wi_yt_player").html(""),300)}).on("click.post","#po_refresh",async function(){const s=a(this);s.html('<i class="fas fa-spinner fa-spin"></i>').prop("disabled",!0),N(s.data("slug")),P(s.data("cat")),await F(s.data("slug"),!0)});const G=()=>a(window).off("scroll.post_prog");export{G as cleanup,F as init,Y as render};
