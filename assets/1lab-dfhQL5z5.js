import"./wiad-DWbEudQX.js";import{$ as i}from"./vendor-PbmUQHyn.js";import{y as v,l as n,x as w,F as b,c as k,I as o,A as y,e as x,n as S}from"./index-D2m2wUVg.js";import{k as u,i as A,l as f,m as I,b as P,o as C,t as L}from"./devblog-DzD7JgHo.js";import"./firebase-DJVx3tD8.js";import"./firebase-BM1KOhEp.js";const h=s=>`<a href="/${s.slug}" class="po_rel_card" ${o(s.resumen||s.titulo)}><div class="po_rel_img"><img src="${s.imagen}" alt="${s.imagenAlt||s.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${s.categoria}</span><strong>${s.titulo}</strong><span class="po_rel_meta"><i class="fas fa-clock"></i> ${s.tiempoLectura} · <i class="fas fa-eye"></i> ${s.vistas||0} . <i class="fas fa-heart"></i> ${s.likes||0}</span></div></a>`,g=(s,d,_,e,a)=>{const c=y.user?.usuario,l=C(s.creado,!0),r=(s.tags||[]).map(p=>`<span class="po_tag">#${p}</span>`).join(""),t=(s.vistas||0)+1;return`
    ...
    <aside class="po_sidebar">
        <div class="po_side_card" data-showi="150">
          ...
          <div class="po_autor_box"><div class="po_autor_av"><img src="/retodelmes/smile.avif" alt="${s.autor}"/></div><div class="po_autor_info"><strong>${s.autor}</strong><span>${x} <i class="fas ${S}"></i></span></div></div>
