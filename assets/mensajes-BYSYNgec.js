import{r as e}from"./vendor-CZ6bxb2j.js";import{t}from"./wii-BvK6d7hI.js";import{D as n,T as r,a as i,f as a,i as o}from"./widev-BkR2Na_W.js";import{i as s}from"./index-Bq5gtrcG.js";import{a as c,g as l,l as u,n as d,o as f,p,u as m,v as h,x as g}from"./firebase-D6VL4aaK.js";import{n as _,t as v}from"./firebase-BfEAzf30.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>a(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email||v.currentUser?.email||``;return`
  <div class="wm_container">
    ...
    <div class="wm_input">
      ...
      <button id="wmEnviar" disabled ${r(`Enviar · Enter`)}><i class="fas fa-paper-plane"></i></button>
    </div>
    ...
    <div class="wm_modal" id="wmEliminar">
      ...
      <button class="wm_del" data-id="${e.id}" ${r(`Eliminar`)}><i class="fas fa-trash"></i></button>
