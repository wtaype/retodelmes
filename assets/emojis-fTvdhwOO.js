import{$ as t}from"./vendor-2D3jvCpt.js";import{b as p,d as x,S as T,G as b,j as S}from"./index-CaICLHnq.js";const C="wii_emojis_notepad",j="wii_emojis_recientes",d={recientes:{icon:"fa-clock",label:"Recientes"},caras:{icon:"fa-smile",label:"Caras"},corazones:{icon:"fa-heart",label:"Corazones"},manos:{icon:"fa-hand-paper",label:"Manos"},animales:{icon:"fa-paw",label:"Animales"},comida:{icon:"fa-utensils",label:"Comida"},objetos:{icon:"fa-lightbulb",label:"Objetos"},simbolos:{icon:"fa-star",label:"Símbolos"},banderas:{icon:"fa-flag",label:"Banderas"}},h={caras:["😀","😃","😄","😁","😆","😅","🤣","😂","🙂","🙃","😉","😊","😇","🥰","😍","🤩","😘","😗","☺️","😚","😙","🥲","😋","😛","😜","🤪","😝","🤑","🤗","🤭","🤫","🤔","🤐","🤨","😐","😑","😶","😏","😒","🙄","😬","🤥","😌","😔","😪","🤤","😴","😷","🤒","🤕","🤢","🤮","🤧","🥵","🥶","🥴","😵","🤯","🤠","🥳","🥸","😎","🤓","🧐","😕","😟","🙁","☹️","😮","😯","😲","😳","🥺","😦","😧","😨","😰","😥","😢","😭","😱","😖","😣","😞","😓","😩","😫","🥱","😤","😡","😠","🤬","😈","👿","💀","☠️","💩","🤡","👹","👺","👻","👽","👾","🤖","😺","😸","😹","😻","😼","😽","🙀","😿","😾"],corazones:["❤️","🧡","💛","💚","💙","💜","🖤","🤍","🤎","💔","❣️","💕","💞","💓","💗","💖","💘","💝","💟","♥️","🫀","❤️‍🔥","❤️‍🩹","🩷","🩵","🩶","💌","💋","👄","🫦","💑","👩‍❤️‍👨","👨‍❤️‍👨","👩‍❤️‍👩","💏","👩‍❤️‍💋‍👨","👨‍❤️‍💋‍👨","👩‍❤️‍💋‍👩","🥰","😍","😘","😻","💐","🌹","🥀","🌷","🌸","💮"],manos:["👋","🤚","🖐️","✋","🖖","👌","🤌","🤏","✌️","🤞","🤟","🤘","🤙","👈","👉","👆","🖕","👇","☝️","👍","👎","✊","👊","🤛","🤜","👏","🙌","👐","🤲","🤝","🙏","✍️","💅","🤳","💪","🦾","🦿","🦵","🦶","👂","🦻","👃","🧠","🫀","🫁","🦷","🦴","👀","👁️","👅","👄","🫦","💋","👶","🧒","👦","👧","🧑","👱","👨","🧔","👩","🧓","👴","👵"],animales:["🐶","🐱","🐭","🐹","🐰","🦊","🐻","🐼","🐻‍❄️","🐨","🐯","🦁","🐮","🐷","🐽","🐸","🐵","🙈","🙉","🙊","🐒","🐔","🐧","🐦","🐤","🐣","🐥","🦆","🦅","🦉","🦇","🐺","🐗","🐴","🦄","🐝","🪱","🐛","🦋","🐌","🐞","🐜","🪰","🪲","🪳","🦟","🦗","🕷️","🦂","🐢","🐍","🦎","🦖","🦕","🐙","🦑","🦐","🦞","🦀","🐡","🐠","🐟","🐬","🐳","🐋","🦈","🐊","🐅","🐆","🦓","🦍","🦧","🦣","🐘","🦛","🦏","🐪","🐫","🦒","🦘"],comida:["🍏","🍎","🍐","🍊","🍋","🍌","🍉","🍇","🍓","🫐","🍈","🍒","🍑","🥭","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥬","🥒","🌶️","🫑","🌽","🥕","🫒","🧄","🧅","🥔","🍠","🥐","🥯","🍞","🥖","🥨","🧀","🥚","🍳","🧈","🥞","🧇","🥓","🥩","🍗","🍖","🦴","🌭","🍔","🍟","🍕","🫓","🥪","🥙","🧆","🌮","🌯","🫔","🥗","🥘","🫕","🍝","🍜","🍲","🍛","🍣","🍱","🥟","🦪","🍤","🍙","🍚","🍘","🍥","🥠","🥮","🍢","🍡","🍧","🍨","🍦","🥧","🧁","🍰","🎂","🍮","🍭","🍬","🍫","🍿","🍩","🍪","🌰","🥜","🍯"],objetos:["📱","💻","⌨️","🖥️","🖨️","🖱️","🖲️","💽","💾","💿","📀","📼","📷","📸","📹","🎥","📽️","🎞️","📞","☎️","📟","📠","📺","📻","🎙️","🎚️","🎛️","🧭","⏱️","⏲️","⏰","🕰️","⌛","⏳","📡","🔋","🔌","💡","🔦","🕯️","🧯","🛢️","💸","💵","💴","💶","💷","🪙","💰","💳","💎","⚖️","🪜","🧰","🪛","🔧","🔨","⚒️","🛠️","⛏️","🪚","🔩","⚙️","🪤","🧱","⛓️","🧲","🔫","💣","🧨","🪓","🔪","🗡️","⚔️","🛡️","🚬","⚰️","🪦","⚱️","🏺"],simbolos:["⭐","🌟","✨","💫","⚡","🔥","💥","☀️","🌙","🌈","☁️","❄️","💧","🌊","🎯","🏆","🥇","🥈","🥉","🏅","🎖️","🎗️","🎪","🎭","🎨","🎬","🎤","🎧","🎼","🎹","🥁","🎷","🎺","🎸","🪕","🎻","🎲","♟️","🎯","🎳","🎮","🕹️","🎰","🧩","♠️","♥️","♦️","♣️","🃏","🀄","🎴","🔮","✅","❌","❓","❗","💯","🔴","🟠","🟡","🟢","🔵","🟣","⚫","⚪","🟤","🔶","🔷","🔸","🔹","🔺","🔻","💠","🔘","🔳","🔲","▪️","▫️","◾","◽"],banderas:["🏳️","🏴","🏁","🚩","🏳️‍🌈","🏳️‍⚧️","🇦🇷","🇧🇴","🇧🇷","🇨🇱","🇨🇴","🇨🇷","🇨🇺","🇩🇴","🇪🇨","🇸🇻","🇬🇹","🇭🇳","🇲🇽","🇳🇮","🇵🇦","🇵🇾","🇵🇪","🇵🇷","🇺🇾","🇻🇪","🇪🇸","🇺🇸","🇬🇧","🇫🇷","🇩🇪","🇮🇹","🇵🇹","🇯🇵","🇰🇷","🇨🇳","🇮🇳","🇷🇺","🇦🇺","🇨🇦","🇳🇱","🇧🇪","🇨🇭","🇦🇹","🇸🇪","🇳🇴","🇩🇰","🇫🇮"]};let r="caras",c=[];const $=()=>S("wiSmile")||{},_=()=>{try{return JSON.parse(localStorage.getItem(j)||"[]")}catch{return[]}},E=a=>{localStorage.setItem(j,JSON.stringify(a.slice(0,32)))},y=a=>{c=_(),c=c.filter(s=>s!==a),c.unshift(a),c=c.slice(0,32),E(c)},w=()=>localStorage.getItem(C)||"",u=a=>localStorage.setItem(C,a),g=async a=>{try{return await navigator.clipboard.writeText(a),!0}catch{const s=document.createElement("textarea");return s.value=a,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select(),document.execCommand("copy"),document.body.removeChild(s),!0}},v=(a="")=>{let s=[];r==="recientes"?s=_():s=h[r]||[],a&&(s=Object.values(h).flat().filter(o=>o.includes(a)));const n=t(".em_grid");if(s.length===0){n.html('<div class="em_empty">No hay emojis</div>');return}n.html(s.map(e=>`
  ...
  <div class="em_container">
    <div class="em_header">
      <div class="em_info">
        <img src="/smile.avif" alt="${x}" class="em_avatar" />
        <div class="em_text">
