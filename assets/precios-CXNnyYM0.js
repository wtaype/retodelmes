import{r as e}from"./vendor-CZ6bxb2j.js";import{f as t,h as n,i as r,m as i,t as a}from"./widev-BkR2Na_W.js";import"./index-C2ky4mwu.js";import{A as o,N as s,O as c,_ as l,m as u,p as d,w as f}from"./firebase-BXqel3Di.js";import{n as p}from"./firebase-Cc-Gk9nK.js";var m=[],h={},g={},_=0,v=`.prec`,y=`toursSmile`,b=()=>`
  <div class="prec_wrap">
...
`;function x(e){return Array.from({length:e},()=>`
  ...
  `}function C(e){return String(e).replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function w(){let t=m.length,n=m.filter(e=>e.activo!==!1).length,r=t-n;e(`#prec_stat_total`).text(t),e(`#prec_stat_activos`).text(n),e(`#prec_stat_inactivos`).text(r)}function T(){if(w(),!m.length){e(`#prec_tbody`).html(`
    ...
    `);return}let t=[...m].sort((e,t)=>(e.num??999)-(t.num??999));e(`#prec_tbody`).html(t.map(e=>S(e,!1)).join(``))}function E(t,n,r){h[t]||(h[t]={}),h[t][n]=r;let i=e(`tr[data-id="${t}"]`);i.addClass(`prec_row_dirty`),i.find(`.prec_btn_save[data-id="${t}"]`).prop(`disabled`,!1).addClass(`prec_btn_save_active`)}function D(t){delete h[t];let n=e(`tr[data-id="${t}"]`);n.removeClass(`prec_row_dirty`),n.find(`.prec_btn_save[data-id="${t}"]`).prop(`disabled`,!0).removeClass(`prec_btn_save_active`)}function O(t,n){let r=e(`tr[data-id="${t}"]`),i=n===`ok`?`prec_row_flash_ok`:`prec_row_flash_err`;r.addClass(i),setTimeout(()=>r.removeClass(i),900)}async function k(t){if(g[t])return;let n=h[t];if(!(!n||!Object.keys(n).length)){g[t]=!0,e(`tr[data-id="${t}"] .prec_btn_save`).prop(`disabled`,!0).html(`<i class="fas fa-circle-notch fa-spin"></i>`);try{await f(o(p,`listatours`,t),{...n,updatedAt:s()});let e=m.findIndex(e=>e.id===t);e!==-1&&Object.assign(m[e],n),i(y),D(t),O(t,`ok`),r(`Tour guardado ✅`,`success`)}catch(e){console.error(`[PRECIOS] saveRow error:`,e),O(t,`err`),r(`Error al guardar el tour`,`error`)}finally{g[t]=!1;let n=e(`tr[data-id="${t}"] .prec_btn_save`);h[t]?n.prop(`disabled`,!1).addClass(`prec_btn_save_active`).html(`<i class="fas fa-save"></i> Guardar`):n.prop(`disabled`,!0).removeClass(`prec_btn_save_active`).html(`<i class="fas fa-save"></i> Guardar`)}}}async function A(t){if(g[t])return;let n=h[t]||{},o=n.tour?.trim()||``;if(!o){r(`El nombre del tour es obligatorio`,`warning`),e(`tr[data-id="${t}"] .prec_in_tour`).trigger(`focus`);return}g[t]=!0;let l=e(`tr[data-id="${t}"] .prec_btn_save`);l.prop(`disabled`,!0).html(`<i class="fas fa-circle-notch fa-spin"></i> Creando…`);try{let e={tour:o,num:Number(n.num)||0,precio:Number(n.precio)||0,puntos:Number(n.puntos)||0,comision:Number(n.comision)||0,activo:n.activo!==!1,createdAt:s(),updatedAt:s()},l=await d(c(p,`listatours`),e),u={id:l.id,...e};m.push(u),i(y),delete h[t],delete g[t],T(),setTimeout(()=>O(l.id,`ok`),50),r(`Tour "${a(o)}" creado ✅`,`success`),w()}catch(e){console.error(`[PRECIOS] createTour error:`,e),g[t]=!1,l.prop(`disabled`,!1).html(`<i class="fas fa-plus-circle"></i> Crear`),r(`Error al crear el tour`,`error`)}}async function j(t){let n=m.find(e=>e.id===t),s=n?a(n.tour||`este tour`):`este tour`;if(!window.confirm(`¿Eliminar "${s}" permanentemente?\n\nEsta acción no se puede deshacer.`))return;let c=e(`tr[data-id="${t}"]`);c.css({opacity:.5,pointerEvents:`none`});try{await u(o(p,`listatours`,t)),m=m.filter(e=>e.id!==t),delete h[t],i(y),c.addClass(`prec_row_removing`),setTimeout(()=>{T()},350),r(`Tour "${s}" eliminado`,`warning`)}catch(e){console.error(`[PRECIOS] deleteTour error:`,e),c.css({opacity:``,pointerEvents:``}),r(`Error al eliminar el tour`,`error`)}}function M(){if(e(`.prec_row_new`).length){e(`tr.prec_row_new .prec_in_tour`).first().trigger(`focus`),r(`Ya hay un tour nuevo pendiente de guardar`,`info`);return}_++;let t=`__new_${_}`,n={id:t,num:m.length+1,tour:``,precio:0,puntos:0,comision:0,activo:!0};h[t]={num:n.num,precio:0,puntos:0,comision:0,activo:!0};let i=S(n,!0);e(`#prec_tbody`).prepend(i),e(`tr[data-id="${t}"] .prec_in_tour`).trigger(`focus`)}async function N(i=!1){if(!i){let e=t(y);if(e){m=e,T();return}}e(`#prec_tbody`).html(x(6)),e(`#prec_header`).addClass(`smw_loading`);try{m=(await l(c(p,`listatours`))).docs.map(e=>({id:e.id,...e.data()})),n(y,m,60),T()}catch(t){console.error(`[PRECIOS] loadTours error:`,t),e(`#prec_tbody`).html(`
      <tr>
        <td colspan="7">
