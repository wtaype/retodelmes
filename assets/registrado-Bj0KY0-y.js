import{$ as a}from"./vendor-2D3jvCpt.js";import{s as e}from"./index-CaICLHnq.js";const s=`
  <div class="reg_wrap">
    <div class="reg_card">
...
`,i=()=>s,c=()=>{a(document).on("click.reg","#reg_btn_back",()=>{e.navigate("/")})},o=()=>{a(document).off(".reg")};export{o as cleanup,c as init,i as render};
