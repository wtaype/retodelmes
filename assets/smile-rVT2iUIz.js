import{$ as a}from"./vendor-PbmUQHyn.js";import{auth as d}from"./firebase-BfeeB13g.js";import{o as v}from"./firebase-BM1KOhEp.js";import{l as _,u as p,k as f,S as h,e as u}from"./index-efS8M9Pg.js";const g=()=>new Promise(e=>{if(d.currentUser)return e(d.currentUser);const s=v(d,r=>{s(),e(r)})}),c=e=>{try{const s=JSON.parse(localStorage.getItem(e));return Array.isArray(s)?s:s?.value&&Array.isArray(s.value)?s.value:[]}catch{return[]}},$=()=>`
  <div class="smw_dash">
