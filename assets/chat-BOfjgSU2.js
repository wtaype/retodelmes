import{r as e}from"./vendor-CZ6bxb2j.js";import{C as t,f as n,h as r,i,n as a,v as o,w as s}from"./widev-BkR2Na_W.js";import{a as c,c as l,d as u,g as d,l as f,n as p,o as m,s as h,t as g,v as ee,x as _}from"./firebase-D6VL4aaK.js";import{n as v}from"./firebase-BfEAzf30.js";import{cargarTodosEmpleados as te}from"./zsmile-9OBMck8o.js";var y=`.chat`,b=`chatSmileMsgs`,x=.1,S=7,C=5,w=500,T=[],E=[],D=``,O=null,k=!1,A=``,j=``,M=!1,N=!0,P=null,F=()=>`
...
`;function I(){return[,,,,,].fill(0).map(()=>`
  ...
  `,U=e=>String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`),W=e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),G=()=>{let t=e(`#chatTextarea`).val()||``;e(`.chat_sidebar_item`).each(function(){let n=(e(this).attr(`data-nombre`)||``).trim();n&&(RegExp(`@`+W(n)+`(?![a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ])`,`i`).test(t)?e(this).addClass(`active`):e(this).removeClass(`active`))})},K=(t=!1)=>{let n=e(`#chatMessages`);if(!T.length){n.html(`
    ...
    `}).join(``);t.html(r),G()},J=(e=!1)=>{let t=document.getElementById(`chatMessages`);t&&t.scrollTo({top:t.scrollHeight,behavior:e?`smooth`:`auto`})},Y=t=>{e(`#chatOnlineCount`).text(t)},X=()=>{O&&=(O(),null),e(`#chatHeader`).addClass(`smw_loading`),O=h(f(d(v,`chatSmiles`),l(`creado`,`desc`),m(S)),t=>{T=t.docs.slice().reverse().map(e=>({id:e.id,...e.data()})),N=t.size>=S,r(b,T,x),K(),Y(new Set(T.map(e=>e.usuario||e.autor).filter(Boolean)).size),e(`#chatHeader`).removeClass(`smw_loading`),e(`#chatRefresh`).removeClass(`chat_spinning`)},t=>{console.error(`[Chat] onSnapshot error:`,t),T.length||e(`#chatMessages`).html(`
      ...
      `),e(`#chatHeader`).removeClass(`smw_loading`),e(`#chatRefresh`).removeClass(`chat_spinning`)})},ne=async()=>{if(M||!N||!T.length)return;let t=e(`#chatMessages`),n=T[0].creado||T[0].ts;if(!n){i(`No se puede paginar: falta cursor de tiempo`,`warning`);return}M=!0,e(`#chatPaginateBtn`).prop(`disabled`,!0).html(`<i class="fas fa-circle-notch fa-spin"></i> Cargando anteriores...`);try{let e=await c(f(d(v,`chatSmiles`),l(`creado`,`desc`),u(n),m(C)));if(e.empty){N=!1,K(!0),i(`No hay más mensajes anteriores`,`info`);return}let r=e.docs.reverse().map(e=>({id:e.id,...e.data()}));r.length<C&&(N=!1);let a=t[0].scrollHeight,o=t[0].scrollTop;T=[...r,...T],K(!0);let s=t[0].scrollHeight;t[0].scrollTop=o+(s-a),i(`Cargados ${r.length} mensajes anteriores`,`success`)}catch(e){console.error(`[Chat] loadAnteriores error:`,e),i(`Error al cargar anteriores`,`error`)}finally{M=!1}},Z=async()=>{try{E=await te(!0),q()}catch(e){console.error(`[Chat] _loadColaboradores error:`,e)}},Q=async()=>{if(!k)return;let t=e(`#chatTextarea`),n=t.val().trim();if(!n)return;if(n.length>w){i(`El mensaje excede ${w} caracteres`,`warning`);return}t.val(``).trigger(`input`),$(t[0]);let a=`temp_`+Date.now()+Math.random().toString(36).substr(2,5),s=o.user,c=s?.imagen||s?.avatar||``,l={id:a,texto:n,usuario:A,email:s?.email||``,nombre:j,imagen:c,creado:new Date,ts:new Date,tipo:`texto`,temp:!0};T.push(l),K(!1),g(d(v,`chatSmiles`),{texto:n,usuario:A,email:s?.email||``,nombre:j,imagen:c,creado:_(),ts:_(),tipo:`texto`}).then(e=>{let t=T.findIndex(e=>e.id===a);t!==-1&&(T[t].id=e.id,delete T[t].temp,r(b,T,x),K(!0))}).catch(e=>{console.error(`[Chat] Background send error:`,e),i(`No se pudo entregar el mensaje`,`error`),T=T.filter(e=>e.id!==a),r(b,T,x),K(!0)})},$=e=>{e&&(e.style.height=`auto`,e.style.height=Math.min(e.scrollHeight,96)+`px`,e.style.overflowY=e.scrollHeight>96?`auto`:`hidden`)},re=()=>{let t=e(`#chatTextarea`),n=e(`#chatSendBtn`),r=e(`#chatBlockedMsg`);k?(t.prop(`disabled`,!1).attr(`placeholder`,`Escribe un mensaje…`),n.prop(`disabled`,!1).removeClass(`chat_send_disabled`),r.hide()):(t.prop(`disabled`,!0).attr(`placeholder`,`No puedes enviar mensajes (participación inactiva)`),n.prop(`disabled`,!0).addClass(`chat_send_disabled`),r.show())},ie=async()=>{e(`.chat_wrap`).addClass(`visible`),window.__WIREADY__=!0;let a=o.user;a&&(A=a.usuario||a.email||``,j=a.nombre||a.usuario||`Colaborador`,k=a.participa===`si`),re();let s=n(b);s&&Array.isArray(s)&&(T=s,N=!0,K()),X(),Z(),e(document).on(`input${y}`,`#chatTextarea`,function(){$(this),G()}),e(document).on(`keydown${y}`,`#chatTextarea`,function(e){e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),Q())}),e(document).on(`click${y}`,`#chatSendBtn`,()=>Q()),e(document).on(`click${y}`,`#chatRefresh`,async function(){r(b,null,0),r(`todosEmpleadosSmile`,null,0),N=!0,e(`#chatRefresh`).addClass(`chat_spinning`),X(),await Z(),i(`Mensajes actualizados`,`success`)}),e(document).on(`click${y}`,`#chatPaginateBtn`,()=>ne()),e(document).on(`click${y}`,`.chat_msg_delete_btn`,function(){let t=e(this).attr(`data-id`);t&&(P=t,e(`#chatEliminarModal`).addClass(`show`))}),e(document).on(`click${y}`,`#chatCancelDeleteBtn, #chatEliminarModal`,function(t){e(t.target).is(`#chatCancelDeleteBtn, #chatEliminarModal`)&&(e(`#chatEliminarModal`).removeClass(`show`),P=null)}),e(document).on(`click${y}`,`#chatConfirmDeleteBtn`,async function(){if(!P)return;let n=this;t(n,!0,`Eliminando...`);try{let t=P;await p(ee(v,`chatSmiles`,t)),i(`Mensaje eliminado permanentemente`,`success`),e(`#chatEliminarModal`).removeClass(`show`),P=null;let n=e(`.chat_bubble_wrap[data-id="${t}"]`);n.length?n.fadeOut(300,function(){e(this).remove(),T=T.filter(e=>e.id!==t),r(b,T,x)}):(T=T.filter(e=>e.id!==t),r(b,T,x),K(!0))}catch(e){console.error(`[Chat] deleteDoc error:`,e),i(`Error al eliminar mensaje`,`error`)}finally{t(n,!1,`Eliminar`)}}),e(document).on(`input${y}`,`#chatSearchInput`,function(){D=e(this).val(),q()}),e(document).on(`click${y}`,`.chat_sidebar_item`,function(t){if(!k)return;let n=(e(this).attr(`data-nombre`)||``).trim(),r=e(`#chatTextarea`),i=e(this).hasClass(`active`),a=r.val(),o=`@${n}`;if(i){let e=n.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),t=RegExp(`@`+e+`(?![a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ])\\s*`,`gi`);a=a.replace(t,``),a=a.replace(/\s+/g,` `).trim(),r.val(a?a+` `:``)}else{let e=a?a.endsWith(` `)?``:` `:``;r.val(a+e+o+` `)}r.trigger(`input`),r.focus(),$(r[0]),e(`#chatContainer`).removeClass(`chat_sidebar_active`)}),e(document).on(`click${y}`,`#chatSidebarToggle`,function(){e(`#chatContainer`).addClass(`chat_sidebar_active`)}),e(document).on(`click${y}`,`#chatSidebarClose`,function(){e(`#chatContainer`).removeClass(`chat_sidebar_active`)}),e(document).on(`click${y}`,`#chatRetry`,()=>{e(`#chatMessages`).html(L()),e(`#chatSidebarList`).html(I()),X(),Z()}),e(document).on(`focus${y}`,`#chatTextarea`,function(){setTimeout(()=>J(!0),350)})},ae=()=>{e(document).off(y),O&&=(O(),null),T=[],E=[],D=``,k=!1,A=``,j=``,M=!1,N=!0,P=null};export{ae as cleanup,ie as init,F as render};