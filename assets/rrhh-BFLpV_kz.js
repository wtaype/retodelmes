import{$ as r}from"./vendor-PbmUQHyn.js";import{db as u}from"./firebase-QWwQUjRS.js";import{i as T,c as D,z as x,e as g,t as P,u as I}from"./firebase-DzkkQdMV.js";import{b as i,j as B,u as m,a as E,C as v,r as w}from"./index-BQyVSIlW.js";let s=[],_="todos",f="",p=null,y=!1;const l="rrhhUsuarios",b=30,H=e=>((e.nombre||"")+" "+(e.apellidos||"")||e.usuario||"?").trim().split(/\s+/).slice(0,2).map(a=>(a[0]||"").toUpperCase()).join(""),L=(e,a=40)=>{if(e.imagen)return`<div class="rrhh_avatar" style="width:${a}px;height:${a}px"><img src="${e.imagen}" alt="${v(e.nombre||e.usuario||"?")}" loading="lazy"/></div>`;const t=H(e);return`<div class="rrhh_avatar rrhh_avatar_initials" data-rol="${e.rol||"smile"}" style="width:${a}px;height:${a}px;font-size:${Math.round(a*.36)}px">${t}</div>`},S=e=>{const a=(e||"smile").toLowerCase();return`<span class="rrhh_rol_badge rrhh_rol_${a}">${v(a)}</span>`},j=e=>{const a=(e||"activo").toLowerCase();return`<span class="rrhh_status rrhh_status_${a}">${E(a)}</span>`},N=(e,a)=>`
