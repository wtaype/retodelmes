...
import{S as $,_ as C}from"./index-efS8M9Pg.js";import{$ as e}from"./vendor-PbmUQHyn.js";import{version as w}from"./waa-DywimY2S.js";import{SUGERENCIAS as v,detectarTema as y}from"./contexto-lpCKRqX0.js";const P=()=>{const i=v.general,a=$().replace(/, $/,"").toLowerCase();return`
<div class="miia">
...
</div>`};let l=!1,x=0,E=null,c=[];const m=()=>({$msg:e("#miiaMessages"),$inp:e("#miiaInput"),$btn:e("#miiaSend")}),r=(i=!1)=>{const a=e(".miia_messages_wrap")[0];a&&(i?a.scrollTo({top:a.scrollHeight,behavior:"smooth"}):a.scrollTop=a.scrollHeight)},S=async()=>E??=await C(()=>import("./brain-C4nzO8JB.js"),__vite__mapDeps([0])),b=i=>i.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>").replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<strong>$1</strong>"),f=(i,a)=>{const{$msg:n}=m(),s=new Date().toLocaleTimeString("es-PE",{hour:"2-digit",minute:"2-digit"}),o=e(`
