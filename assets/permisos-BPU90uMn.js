import{$ as a}from"./vendor-PbmUQHyn.js";import{b as r,j as v,e as u}from"./index-BQyVSIlW.js";import{db as p}from"./firebase-QWwQUjRS.js";import{h as g,e as _,z as y,q as $,c as w,C as E,i as P}from"./firebase-DzkkQdMV.js";const h=()=>v("wiSmile");let l=[];const I=()=>{const i=h();return!i||i.rol!=="admin"?'<div class="adp_page"><div class="adp_empty"><i class="fas fa-ban"></i><p>Acceso denegado.</p></div></div>':`
  <div class="adp_page">
  ...
  `).join("");a("#adp_modales").html(`
    ...
    </div>`)}export{A as cleanup,x as init,I as render};
