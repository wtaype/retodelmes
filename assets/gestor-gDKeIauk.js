import{$ as o}from"./vendor-PbmUQHyn.js";import{auth as d}from"./firebase-BfdqDjIw.js";import{o as u}from"./firebase-BM1KOhEp.js";import{e as c,l as f,u as p,k as v,S as h}from"./index-6xkMC4FG.js";const _=()=>new Promise(s=>{if(d.currentUser)return s(d.currentUser);const e=u(d,t=>{e(),s(t)})}),r=s=>{try{const e=JSON.parse(localStorage.getItem(s));return Array.isArray(e)?e:e?.value&&Array.isArray(e.value)?e.value:[]}catch{return[]}},F=()=>`
  <div class="gs_dash">
