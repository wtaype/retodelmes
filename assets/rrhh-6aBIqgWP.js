import{r as e}from"./vendor-CZ6bxb2j.js";import{f as t,h as n,i as r,m as i,n as a,t as o}from"./widev-BkR2Na_W.js";import"./index-By8tpuOv.js";import{a as s,f as c,g as l,v as u,x as d}from"./firebase-D6VL4aaK.js";import{n as f}from"./firebase-BfEAzf30.js";import{iniciarModal as p}from"./trabajador_nuevo-Gueehciu.js";var m=[],h=`todos`,g=``,_=null,v=!1,y=`rrhhUsuarios`,b=30,x=e=>((e.nombre||``)+` `+(e.apellidos||``)||e.usuario||`?`).trim().split(/\s+/).slice(0,2).map(e=>(e[0]||``).toUpperCase()).join(``),S=(e,t=40)=>{if(e.imagen)return`<div class="rrhh_avatar" style="width:${t}px;height:${t}px"><img src="${e.imagen}" alt="${o(e.nombre||e.usuario||`?`)}" loading="lazy"/></div>`;let n=x(e);return`<div class="rrhh_avatar rrhh_avatar_initials" data-rol="${e.rol||`smile`}" style="width:${t}px;height:${t}px;font-size:${Math.round(t*.36)}px">${n}</div>`},C=e=>{let t=(e||`smile`).toLowerCase();return`<span class="rrhh_rol_badge rrhh_rol_${t}">${o(t)}</span>`},w=(e,t)=>{let n=t===`activo`;return`
