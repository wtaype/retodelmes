import{x as I,y as f,F as M,e as y,c as D,l as h,I as e,A as E,n as R,K as C,_ as m}from"./index-_8gLK-S4.js";import{a as L}from"./wiad-DWbEudQX.js";import{$ as a}from"./vendor-PbmUQHyn.js";import{i as T,b as z,g,l as V,m as j,k as O,o as w,t as q,a as B,e as N,f as P}from"./devblog-CFwF38kR.js";import"./firebase-BoXYLQFr.js";import"./firebase-BM1KOhEp.js";const _=s=>`<a href="/${s.slug||s.id}" class="po_rel_card" ${e(s.resumen||s.titulo)}><div class="po_rel_img"><img src="${s.imagen}" alt="${s.imagenAlt||s.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${s.categoria}</span><strong>${s.titulo}</strong><span class="po_rel_meta"><i class="fas fa-calendar"></i> ${w(s.actualizado||s.creado)} · <i class="fas fa-eye"></i> ${s.vistas||0} · <i class="fas fa-heart" style="color:#fe0149"></i> ${s.likes||0}</span></div></a>`,b=(s,i,t="po_fade po_visible")=>s||i?`
