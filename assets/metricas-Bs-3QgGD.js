import{f as e}from"./widev-BkR2Na_W.js";import{a as t,g as n,l as r,p as i}from"./firebase-D6VL4aaK.js";import{n as a}from"./firebase-BfEAzf30.js";var o=async()=>`
  ...
  `,s=async()=>{let o=e(`wiSmile`);if(o)try{let e=await t(r(n(a,`linkwiis`),i(`usuario`,`==`,o.usuario))),s=0,c=0,l=[];e.forEach(e=>{let t=e.data(),n=t.vistas||0,r=t.links?t.links.filter(e=>e.url||e.titulo).length:0;s+=n,c+=r,l.push({slug:e.id,vistas:n,linksCount:r,logo:t.logo})}),l.sort((e,t)=>t.vistas-e.vistas);let u=`
