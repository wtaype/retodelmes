/* empty css               */import{$ as e}from"./vendor-PbmUQHyn.js";import{e as i,K as p}from"./index-D2m2wUVg.js";const g=()=>`
<main id="wimain">
<div class="ac_wrap">
...
`,v=()=>{e(".ac_counter_num").each(function(){const o=e(this),c=o.data("target");if(!c)return;const t=parseInt(c),a=2e3;let s=null;const r=n=>{s||(s=n);const d=Math.min((n-s)/a,1),l=1-Math.pow(1-d,4),_=Math.floor(l*t);o.text(_.toLocaleString()),d<1&&requestAnimationFrame(r)};requestAnimationFrame(r)})},h=()=>{const o=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&e(s.target).addClass("visible")})},{threshold:.1});e(".wi_fadeUp").each(function(){o.observe(this)});const c=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(v(),c.disconnect())})},{threshold:.5}),t=document.querySelector(".ac_counter_band");t&&c.observe(t),e("#ac_compartir").on("click",function(){const a=window.location.origin;navigator.share?navigator.share({title:i,text:`🔒 Acceso interno de ${i} - Plataforma de Ventas.`,url:a}).catch(()=>{}):p(a,this,"¡Link copiado!")}),window.wiInitTips&&window.wiInitTips(),console.log(`🔒 ${i} Acerca actualizado`),window.__WIREADY__=!0},b=()=>{e("#ac_compartir").off("click")};export{b as cleanup,h as init,g as render};
