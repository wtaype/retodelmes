import{$ as t}from"./vendor-2D3jvCpt.js";import{auth as E,db as _}from"./firebase-BPYZb32v.js";import{v as I,e as y,d as L,r as T,c as H,D as M,n as N,i as q,u as A}from"./firebase-BwR1K4LJ.js";import{s as O,I as J,d as U,S as V,G as p,j as B,b as w}from"./index-Ds5QDkyH.js";let i=[],l=null,u=!1,v=null,m=null;const $="wi_mensajes_cache",F=50,g=()=>B("wiSmile")||{},d=e=>{try{localStorage.setItem($,JSON.stringify(e))}catch{}},D=()=>{try{return JSON.parse(localStorage.getItem($)||"[]")}catch{return[]}},C=()=>{const e=document.getElementById("wmChat");e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},Z=()=>{const e=g();if(!e.email)return location.replace("/"),"";const s=e.nombre||e.usuario||e.email||E.currentUser?.email||"";return`
