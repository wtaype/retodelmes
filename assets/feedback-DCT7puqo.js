...
</div></main>`;let i=null;const m=()=>{i=new IntersectionObserver(a=>a.forEach(s=>{s.isIntersecting&&c(s.target).addClass("visible")}),{threshold:.1}),c(".wi_fadeUp").each(function(){i.observe(this)}),c(document).on("click.feedback",".fb_canal",function(a){const s=c(this).attr("href");s&&s.startsWith("/")&&(a.preventDefault(),e(()=>import("./index-B3suI07f.js").then(o=>o.v),__vite__mapDeps([0])).then(o=>o.rutas.navigate(s)))}),console.log(`💬 ${t} Feedback cargado`)},f=()=>{i?.disconnect?.(),i=null,c(document).off(".feedback")};export{f as cleanup,m as init,v as render};
