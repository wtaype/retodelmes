import{$ as i}from"./vendor-PbmUQHyn.js";import{auth as y,db as u}from"./firebase-QWwQUjRS.js";import{a as I,c as h,d as A,e as b,q as L,C as T,i as S,t as f}from"./firebase-DzkkQdMV.js";import{b as n,E as l,j as U,G as p}from"./index-BQyVSIlW.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},C=async(s,t)=>{await A(b(u,s,t))},B=()=>g(e),D=()=>g(d),$=(s,t)=>`
...
</div>`,_=(s,t)=>s.length?s.map(r=>$(r,t)).join(""):'<p class="ag_vacio"><i class="fas fa-inbox"></i> Sin elementos guardados</p>',q=()=>`
<div class="agregar">
