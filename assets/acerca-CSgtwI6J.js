/* empty css               */import{$ as c}from"./vendor-2D3jvCpt.js";import{d as i,I as p}from"./index-CaICLHnq.js";const g=()=>`
<main id="wimain">
<div class="ac_wrap">
  ...
  <section class="ac_sec">
    <div class="ac_sec_head">
      ...
      <h2 class="ac_sec_tit">El propósito de <span class="ac_grad">${i}</span></h2>
    </div>
    <div class="ac_historia wi_fadeUp">
      <p><strong>${i}</strong> es una plataforma interna exclusiva diseñada para optimizar y transparentar el registro de los tours vendidos y ejecutados por nuestro equipo de guías y agentes comerciales en la región de Ica-Huacachina.</p>
...
`,v=()=>{c(".ac_counter_num").each(function(){const o=c(this),e=o.data("target");if(!e)return;const t=parseInt(e),a=2e3;let s=null;const r=n=>{s||(s=n);const d=Math.min((n-s)/a,1),l=1-Math.pow(1-d,4),_=Math.floor(l*t);o.text(_.toLocaleString()),d<1&&requestAnimationFrame(r)};requestAnimationFrame(r)})},h=()=>{const o=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&c(s.target).addClass("visible")})},{threshold:.1});c(".wi_fadeUp").each(function(){o.observe(this)});const e=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(v(),e.disconnect())})},{threshold:.5}),t=document.querySelector(".ac_counter_band");t&&e.observe(t),c("#ac_compartir").on("click",function(){const a=window.location.origin;navigator.share?navigator.share({title:i,text:`🔒 Acceso interno de ${i} - Plataforma de Ventas.`,url:a}).catch(()=>{}):p(a,this,"¡Link copiado!")}),window.wiInitTips&&window.wiInitTips(),console.log(`🔒 ${i} Acerca actualizado`),window.__WIREADY__=!0},b=()=>{c("#ac_compartir").off("click")};export{b as cleanup,h as init,g as render};
