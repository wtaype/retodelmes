import{o as dt,a as m,b as F,q as L,c as P,w as E,f as K,$ as e,n as Q,l as ut,d as S,i as k,p as j,h as H,m as ft}from"./init-Gtr2X5bl.js";import"./foo-BmG5pIek.js";import{g as I,i as G,s as D,N as i,m as Z,C as B,r as $}from"./widev-87OU-e6I.js";let f=null,w=new Date(new Date().toLocaleString("en-US",{timeZone:"America/Lima"})).toISOString().slice(0,7),b="todos",l=0,T=0,v=[],y=[],u=[],A=7,p=[],N=!1,R=null;dt(K,async t=>{if(!t)return window.location.href="/";R=t;try{const o=I("wiSmileTop");if(o)return W(o),G(m,R);const n=(await F(L(P(m,"smiles"),E("usuario","==",t.displayName)))).docs[0].data();D("wiSmile",n,450),W(n),G(m,R)}catch(o){console.error(o)}});async function W(t){f=t,console.log(`✅ Admin: ${t.nombre}`),e(".app").html(pt());try{await tt(),await z(),await at(),await _(),await nt(),bt(),C(),x(),i("Bienvenido "+t.nombre,"success")}catch(o){console.error("Error init:",o),i("Error al inicializar","error")}}function pt(){return`
            ...
            <main class="main-content">
                <section class="filters-bar">
                    <div class="filter-group">
                        ...
                        <select id="monthFilter">${mt()}</select>
                    </div>
                    <div class="filter-group">
    ...
    `}function J(t,o,a){e("#totalVentas").text(`${t.length} ${t.length===1?"venta":"ventas"}`),e("#totalIngresos").text(`S/ ${o.toFixed(2)}`),e("#totalPuntos").text(`${a} puntos`)}function ht(){const t=e("#pagination"),o=e("#prevPage"),a=e("#nextPage"),n=e("#pageNumbers");if(T<=1){t.hide();return}let s="";const r=8;let d=Math.max(0,l-Math.floor(r/2)),h=Math.min(T-1,d+r-1);h-d<r-1&&(d=Math.max(0,h-r+1));for(let g=d;g<=h;g++)s+=`
            <button class="btn-page page-number ${g===l?"active":""}" data-page="${g}">
                ${g+1}
            </button>
        `;n.html(s),o.prop("disabled",l===0),a.prop("disabled",l>=T-1),t.show()}async function _(){try{console.log("🔄 Cargando tours...");const t=I("toursSmileTop");if(t&&t.length>0){p=t,console.log(`✅ ${p.length} tours desde cache`),M();return}console.log("📡 Cargando desde Firestore...");const o=await F(P(m,"listatours"));if(o.empty){console.log("📭 No hay tours en Firestore"),p=[],M();return}p=o.docs.map(a=>({id:a.id,...a.data()})),D("toursSmileTop",p,300),console.log(`✅ ${p.length} tours cargados y guardados en cache`),M()}catch(t){console.error("❌ Error cargando tours:",t),i("Error al cargar tours","error"),e("#toursContainer").html(`
            <div class="empty-state">
...
Esta acción no se puede deshacer.`)))try{await ut(S(m,"listatours",t)),$("toursSmileTop"),await _(),i("🗑️ Tour eliminado correctamente","success")}catch(n){console.error("Error eliminar tour:",n),i("❌ Error al eliminar tour","error")}};window.refreshToursFromDB=async function(){console.log("🔄 Forzando recarga desde Firebase..."),$("toursSmileTop"),await _(),i("✅ Tours actualizados desde Firebase","success")};window.saveTour=async function(t,o){const a=e("#tourNombre").val().trim(),n=parseFloat(e("#tourPrecio").val())||0,s=parseFloat(e("#tourComision").val())||0,r=parseInt(e("#tourPuntos").val())||0;if(!a){i("⚠️ El nombre del tour es obligatorio","error"),e("#tourNombre").focus();return}if(n<=0){i("⚠️ El precio debe ser mayor a 0","error"),e("#tourPrecio").focus();return}try{if(t){const d={activo:!0,comision:s,tour:a,precio:n,puntos:r,actualizadoPor:f.nombre||f.usuario||"Admin",fecha:k()};await j(S(m,"listatours",t),d),i("✅ Tour actualizado correctamente","success")}else{const d=p.length>0?Math.max(...p.map(c=>c.num||0))+1:1,h={activo:!0,comision:s,tour:a,precio:n,puntos:r,num:d,creadoPor:f.nombre||f.usuario||"Admin",actualizadoPor:f.nombre||f.usuario||"Admin",fecha:k()},g=Date.now().toString();await H(S(m,"listatours",g),h),i(`✅ Tour #${d} creado correctamente`,"success")}$("toursSmileTop"),await _()}catch(d){console.error("❌ Error guardar tour:",d),i("❌ Error al guardar tour: "+d.message,"error")}};window.showAddForm=st;window.loadTours=_;function x(){const t=e("#notesContainer");if(!u||u.length===0){t.html(`
            <div class="empty-state">
