import{a as e}from"./widev-D5ebok9f.js";var t=()=>{let t=e().replace(/, $/,``).toLowerCase();return`
...
6. REGLA DEL PRIMER MENSAJE: Si el usuario te envía exactamente algo como "me gustaría que ores por mí, por favor", tu respuesta DEBE ser súper empática y decir algo muy parecido a esto: "${t.charAt(0).toUpperCase()+t.slice(1)}, lamento mucho la situación que estás pasando. Con muchísimo gusto oraré por ti. Dime, ¿cuál es tu nombre y por qué te gustaría que oremos hoy?"
