import{$ as i}from"./vendor-PbmUQHyn.js";import{auth as y,db as u}from"./firebase-DEygbzCU.js";import{a as I,c as h,d as A,e as b,r as L,D as T,i as S,u as f}from"./firebase-BM1KOhEp.js";import{c as n,G as l,l as U,I as p}from"./index-DGoqYIeX.js";const e="wiAudios",d="wiImg",m=()=>U("wiSmile")?.email||y.currentUser?.email||"",g=async s=>{const t=m();if(!t)return[];const r=L(h(u,s),T("email","==",t));return(await S(r)).docs.map(c=>({id:c.id,...c.data()})).sort((c,o)=>(o.creado?.seconds||0)-(c.creado?.seconds||0))},v=async(s,t,r)=>{const a=m();return a?(await I(h(u,s),{email:a,titulo:t,src:r,creado:f(),actualizado:f()})).id:null},$=async(s,t)=>{await A(b(u,s,t))},D=()=>g(e),B=()=>g(d),x=(s,t)=>`
