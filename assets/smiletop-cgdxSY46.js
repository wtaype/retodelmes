import{r as g,i as b,$ as i,t as y,M as n,F as o,c as d,e as u,a as m,G as $,b as w,D as A}from"./widev-0Seri7mO.js";g(b,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const h=`
