import{r as e}from"./vendor-CZ6bxb2j.js";import{C as t,f as n,h as r,i,m as a,v as o}from"./widev-BkR2Na_W.js";import{i as s}from"./index-yzVrr24k.js";import{a as c,g as l,u,v as d,x as f}from"./firebase-D6VL4aaK.js";import{n as p}from"./firebase-BfEAzf30.js";import{cargarTours as m,getMesActual as h,invalidateRankingCaches as g,obtenerRankingMes as _}from"./zsmile-9OBMck8o.js";var v=[],y=null,b=null,x=!1,S=()=>`
...
`,C=async()=>{let t=o.user,r=e(`#smwRegCard`);r.addClass(`smw_loading`),e(`#tourDisplay`).addClass(`smw_loading_select`),e(`#formularioVenta`).removeClass(`smw_show_checks`);let i=[`Enero`,`Febrero`,`Marzo`,`Abril`,`Mayo`,`Junio`,`Julio`,`Agosto`,`Septiembre`,`Octubre`,`Noviembre`,`Diciembre`],[a,s]=h().split(`-`);e(`#lblMesActual`).text(`${i[parseInt(s)-1]} ${a}`);let c=n(`toursSmile`);c?.length>0&&(v=c.map(e=>({nt:e.num||Math.random(),tour:e.tour,price:parseFloat(e.precio)||0,pts:parseInt(e.puntos)||0,com:parseFloat(e.comision)||5})),T(v)),m().then(e=>{v=e,T(v),L(t,!0),V(!0),F()}).catch(e=>console.error(`Error al cargar tours:`,e)).finally(()=>{r.removeClass(`smw_loading`),e(`#tourDisplay`).removeClass(`smw_loading_select`)}),E().catch(e=>console.error(e)),O(t.usuario).catch(e=>console.error(e)),A(),L(t),V(),F();for(let e of[100,300,600,1e3,1800,3e3])setTimeout(F,e)},w=()=>{e(document).off(`.registrar`),y=null,v=[],b=null,x=!1};function T(t){if(!t.length){e(`#tourTableBody`).html(`<tr><td colspan="4" style="text-align:center;color:var(--tx3);padding:2vh;">Sin resultados para la búsqueda</td></tr>`);return}let n=t.map((e,t)=>`
