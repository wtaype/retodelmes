import{y as k,j as A,b as f,E as M,M as I,_ as N,q as V,G as w,B as G}from"./index-BQyVSIlW.js";import{$ as a}from"./vendor-PbmUQHyn.js";import{db as S}from"./firebase-QWwQUjRS.js";import{h as O,e as T,z as K,t as L,u as U}from"./firebase-DzkkQdMV.js";import{i as J,w as W,C as E,e as Q,d as R}from"./devblog-CFkKKv_r.js";const F=_=>_.trim().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g," ").replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").replace(/_{2,}/g,"_").replace(/^_|_$/g,"").slice(0,50),z=_=>{const s=_.replace(/<[^>]*>/g," ").split(/\s+/).filter(Boolean);return{words:s.length,min:Math.max(1,Math.ceil(s.length/200))}},B=()=>G.params()?.edit||new URLSearchParams(location.search).get("edit")||null,ea=()=>{const _=k.user?.usuario?k.user:A("wiSmile")||{};if(!_.email)return'<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>';const s=B();return`
  <div class="nu_wrap">
    <div class="nu_head">
      ...
      <div class="nu_left">
        <div class="nu_card">
          ...
          <div class="nu_slug_box">
            <span class="nu_slug_label"><i class="fas fa-link"></i> ${V}</span>
