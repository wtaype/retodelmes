...
const TIPOS = [
  {
    ...
    tit: 'Tokens de Sesión y Autenticación',
    desc: 'Necesarias para el ingreso y funcionamiento de la aplicación corporativa.',
    items: ['Mantiene activa tu sesión de trabajo de forma segura.', 'Se destruyen al cerrar sesión en el menú.', 'No recopilan datos de navegación externos.'],
  },
  {
    ico: 'fa-hard-drive', color: '#29C72E', tag: 'Caché Local',
    tit: 'LocalStorage (Preferencias y Venta Offline)',
    desc: 'Almacenamiento local del navegador para permitir el funcionamiento fluido incluso en zonas con baja señal.',
    items: ['Guarda temporalmente tus tours pendientes de validación.', 'Almacena tus configuraciones estéticas de tema (Oscuro, Claro, etc.).', 'Caché técnica de los 18 tours autorizados para carga instantánea.'],
  },
];
...
<div class="ac_wrap tm_wrap">
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <div class="tm_last_upd"><i class="fas fa-calendar-check"></i> Última actualización: Mayo ${year()} · Versión ${version}</div>
    </div>
  </section>
