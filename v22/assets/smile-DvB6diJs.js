import{t as y,b as x,c as C,a as g,l as D,$ as t,v as U,g as da,d as I,j as X,i as Q,N as d,x as L,q as Z,e as aa,y as ua,C as W,z as pa,A as Y,M as ta,B as J,D as fa,E as ma,F as va,h as ea}from"./widev-CZx_InEv.js";function k(){const a=`empleadosPuntos_${$}`,e=y(a);e?.length>0&&u.length===0&&u.push(...e);const o=u.map((s,n)=>{const r=n+1,l=r===1?"champion":r===2?"runner-up":"",i=r===1?"crown":r===2?"medal":"user";return`
