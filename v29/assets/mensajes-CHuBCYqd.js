import{$ as t}from"./vendor-PbmUQHyn.js";import{auth as E,db as _}from"./firebase-BFRo59O5.js";import{v as I,e as y,d as L,r as T,c as H,D as M,n as N,i as q,u as A}from"./firebase-BM1KOhEp.js";import{u as O,K as J,e as K,S as U,I as p,l as V,c as w}from"./index-Cmzf1Q84.js";let i=[],l=null,u=!1,v=null,m=null;const $="wi_mensajes_cache",B=50,g=()=>V("wiSmile")||{},d=e=>{try{localStorage.setItem($,JSON.stringify(e))}catch{}},D=()=>{try{return JSON.parse(localStorage.getItem($)||"[]")}catch{return[]}},C=()=>{const e=document.getElementById("wmChat");e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},Z=()=>{const e=g();if(!e.email)return location.replace("/"),"";const s=e.nombre||e.usuario||e.email||E.currentUser?.email||"";return`
