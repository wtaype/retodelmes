import{h as V,c as k,d as P,$ as t,g as ba,f as R,k as na,l as ra,q as la,w as ca,e as ya,o as $a,n as Sa,a as da}from"./init-K98cp_Uf.js";/* empty css              */import{f as wa}from"./foo-DJJaD4eS.js";import{d as C,e as x,s as ua,C as X,N as v,m as Ta,g as Pa,b as ea,M as pa,r as Q,w as oa}from"./widev-DxvgDuDE.js";function F(){const a=C(`empleadosPuntos_${g}`);if(a)return sa(a);if(!h.length)return t(".app").html('<div class="estado-vacio"><i class="fa-solid fa-spinner fa-spin"></i><p>Cargando empleados...</p></div>');x(`empleadosPuntos_${g}`,h,5),sa(h)}function sa(a){const e=a.map((o,s)=>{const c=s+1,l=c===1?"champion":c===2?"runner-up":"",r=c===1?"crown":c===2?"medal":"user";return`
